...
import { ProcurementPricecomparisonQuoteLookupService } from '../filters/quote-column-filter.service';
...
export abstract class SingleQuoteContractWizardService<RT extends CompareColumnCompositeSingleQuoteBaseResponse = CompareColumnCompositeSingleQuoteBaseResponse> {
	...
	protected readonly quoteSvc = ServiceLocator.injector.get(ProcurementPricecomparisonQuoteLookupService);
