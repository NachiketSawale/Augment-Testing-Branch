...
/**
 * Transaction layout service in pes
 */
@Injectable({
	providedIn: 'root',
})
export class ProcurementPesTransactionLayoutService {
	private readonly lazyInjector = inject(PlatformLazyInjectorService);

	public async generateConfig(): Promise<ILayoutConfiguration<IPesTransactionEntity>> {
		const bpRelatedLookupProvider = await this.lazyInjector.inject(BUSINESSPARTNER_RELATED_LOOKUP_PROVIDER_TOKEN);
		return <ILayoutConfiguration<IPesTransactionEntity>>{
			groups: [
				{
					gid: 'basicData',
					title: {
			...
			labels: {
				...prefixAllTranslationKeys('procurement.pes.', {
					DateDocument: { key: 'entityDocumentDate', text: 'Document Date' },
					DateDelivered: {
				...
				...prefixAllTranslationKeys('cloud.common.', {
					...
					PesStatusFk:{key:'entityStatus',text:'Status'},
			...
			overloads: {
				...
				BusinessPartnerFk: bpRelatedLookupProvider.getBusinessPartnerLookupOverload({ displayMember: 'BusinessPartnerName1', readonly: true }), 
				SupplierFk: bpRelatedLookupProvider.getSupplierLookupOverload({showClearButton: true, readonly: true}), 
				ContactFk: bpRelatedLookupProvider.getContactLookupOverload({displayMember: 'FullName', readonly: true}), 
				...
				TaxCodeFk: ProcurementSharedLookupOverloadProvider.provideTaxCodeLookupOverload(true),
				...
				MaterialFk: BasicsSharedLookupOverloadProvider.provideMaterialLookupOverload(false, 'cloud.common.entityCode'),
				...
				PesStatusFk:BasicsSharedCustomizeLookupOverloadProvider.providePesStatusReadonlyLookupOverload(),
				PrjStockFk: ProjectSharedLookupOverloadProvider.provideProjectStockReadonlyLookupOverload(),
				PrjStockLocationFk: ProjectSharedLookupOverloadProvider.provideProjectStockLocationOptionLookupOverload({
					readonly: true
				}),
				TaxCodeMatrixCode:{readonly:true},
				PrcItemFk: {
