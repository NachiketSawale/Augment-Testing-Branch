...
(function () {
	...
	function kendoSplitterAdjust($timeout, platformGridAPI) {
		return {
			...
			link: function (scope, elem) {
				...
				let defaultPanesConfig = {panes: [{collapsible: true, size: '50%'}, {collapsible: true, size: '50%'}], orientation: 'horizontal'};
				// init config
				let panesConfig = scope.option ? scope.option : defaultPanesConfig;
	...
	angular.module('businesspartner.main').directive('businesspartnerKendoSplitterAdjustExtend', ['$timeout', 'platformGridAPI', kendoSplitterAdjust]);
})();