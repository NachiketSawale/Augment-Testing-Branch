...
(function (angular) {
	...
	ControlTowerModul.factory('businesspartnerMainPowerBiDataService', BusinesspartnerMainPowerBiDataService);
	BusinesspartnerMainPowerBiDataService.$inject = ['mtwoControlTowerConfigurationMainService',
	...
	function BusinesspartnerMainPowerBiDataService(mtwoControlTowerConfigurationMainService, platformDataServiceFactory,
		platformDataServiceProcessDatesBySchemeExtension, ServiceDataProcessArraysExtension,
		mtwoControlTowerConfigurationImageProcessor, businesspartnerMainHeaderDataService) {
		...
		businesspartnerMainHeaderDataService.registerListLoaded(function () {
			serviceContainer.service.load();
		});
		...
		function getSearchFilter() {
			return {
				CallingModule: 'businesspartner.main'
			};
		}
