(function () {
	...
	angular.module('businesspartner.main').controller('businesspartnerMainSupplierOpenItemListController',
		['$scope', '$http', '$timeout', '$translate', '_','platformModalService',
			'PlatformMessenger', 'platformGridAPI',
			'businesspartnerSupplierOpenItemService', 'platformGridControllerService',
			/* jshint -W072 */ // many parameters because of dependency injection
			function ($scope, $http, $timeout, $translate,_,platformModalService, PlatformMessenger, platformGridAPI, businesspartnerSupplierOpenItemService, platformGridControllerService) {
				...
				const columns =  [
					{
						...
						field: 'Vendor_No',
						name: 'Vendor No.',
						name$tr$: 'businesspartner.main.openItem.vendorNo',
					...
					},
					{
						...
						field: 'Vendor_Name',
						name: 'Vendor Name',
						name$tr$: 'businesspartner.main.openItem.vendorName',
						formatter: 'description',
						readonly: true
					},
					{
					...
					},
					{
						...
						name: 'Purchaser Person',
						name$tr$: 'businesspartner.main.openItem.purchaserCode',
						formatter: 'code',
						readonly: true
					},
					{
				...
				platformGridControllerService.initListController($scope, columnDef, businesspartnerSupplierOpenItemService, null, gridConfig);
