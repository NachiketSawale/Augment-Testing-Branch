...
(function (angular) {
	...
	/**
	 * @name businesspartnerMainPowerbiViewController
	 * @function
	 */
	...
	ControlTowerModul.controller('businesspartnerMainPowerbiViewController', BusinesspartnerMainPowerbiViewController);
	BusinesspartnerMainPowerbiViewController.$inject = [
		'$scope',
		'$translate',
	...
	function BusinesspartnerMainPowerbiViewController(
		$scope,
		$translate,
		businesspartnerMainPowerBiDataService,
		platformModalService,
		...
		function loadReport() {
			var selectedItem = businesspartnerMainPowerBiDataService.getSelected();
		...
		businesspartnerMainPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, businesspartnerMainPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			businesspartnerMainPowerBiDataService.unregisterSelectionChanged(loadReport);
