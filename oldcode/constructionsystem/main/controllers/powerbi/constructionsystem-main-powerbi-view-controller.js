...
(function (angular) {
	...
	ControlTowerModul.controller('constructionsystemMainPowerbiViewController',ConstructionsystemMainPowerbiViewController);
	ConstructionsystemMainPowerbiViewController.$inject = [
		'$scope',
		'$translate',
	...
	function ConstructionsystemMainPowerbiViewController(
		$scope,
		$translate,
		constructionsystemgMainPowerBiDataService,
		platformModalService,
		platformGridControllerService,
		mtwoControlTowerUIStandardService,
		mtwoControlTowerValidationService,
		...
		function loadReport() {
			var selectedItem = constructionsystemgMainPowerBiDataService.getSelected();
		...
		constructionsystemgMainPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, constructionsystemgMainPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			constructionsystemgMainPowerBiDataService.unregisterSelectionChanged(loadReport);
