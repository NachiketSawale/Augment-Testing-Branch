...
(function(angular) {
	...
	angular.module(moduleName).factory('constructionSystemMainDimensionService', [
		'$http',
		...
		function(
			...
			var service,
				options = {
					...
					onDimensionsCreated: function (res) {
						// update model object lookup cache.
						var modelId = constructionSystemMainInstanceService.getCurrentSelectedModelId();
						modelMainObjectLookupDataService.setFilter(modelId);
						var list = modelMainObjectLookupDataService.getListSync({
						...
						refreshObjects(lastItem.ModelFk,  {
							modelId: lastItem.ModelFk,
							objectId: lastItem.ModelObjectFk
						});

						refreshAssignedObjects(lastItem.ModelFk,  {
							modelId: lastItem.ModelFk,
							objectId: lastItem.ModelObjectFk
						});
					},
