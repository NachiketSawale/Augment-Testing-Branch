...
(function (angular) {
	...
	ControlTowerModul.factory('constructionsystemMainPowerBiDataService', ConstructionsystemMainPowerBiDataService);
	ConstructionsystemMainPowerBiDataService.$inject = ['mtwoControlTowerConfigurationMainService',
	...
	function ConstructionsystemMainPowerBiDataService(mtwoControlTowerConfigurationMainService, platformDataServiceFactory,
		platformDataServiceProcessDatesBySchemeExtension, ServiceDataProcessArraysExtension,
		mtwoControlTowerConfigurationImageProcessor,constructionSystemMainInstanceService) {
		...
		constructionSystemMainInstanceService.registerListLoaded(function () {
			serviceContainer.service.load();
		});
		...
		function getSearchFilter(){
			return {
				CallingModule: 'constructionsystem.main'
			};
		}
