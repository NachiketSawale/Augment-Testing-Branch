...
(function (angular) {
	...
	ControlTowerModul.controller('constructionsystemMasterPowerbiViewController',ConstructionsystemMasterPowerbiViewController);
	ConstructionsystemMasterPowerbiViewController.$inject = [
		'$scope',
		'$translate',
	...
	function ConstructionsystemMasterPowerbiViewController(
		$scope,
		$translate,
		constructionsystemMasterPowerBiDataService,
		platformModalService,
		...
		function loadReport() {
			var selectedItem = constructionsystemMasterPowerBiDataService.getSelected();
		...
		constructionsystemMasterPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, constructionsystemMasterPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			constructionsystemMasterPowerBiDataService.unregisterSelectionChanged(loadReport);
