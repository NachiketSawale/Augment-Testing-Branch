...
(function (angular) {
	...
	/**
	 * @ngdoc controller
	 * @name constructionSystemMasterObjectTemplate2TemplateDetailController
	 * @require $scope
	 * @description controller for construction System Master Object Template To Template Detail Controller
	 */

	var modulename = 'constructionsystem.master';
	angular.module(modulename).controller('constructionSystemMasterObjectTemplate2TemplateDetailController', [
		'$injector',
		'$scope',
