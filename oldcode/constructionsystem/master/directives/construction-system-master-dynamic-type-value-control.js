...
(function (angular) {
	...
	angular.module(moduleName).directive('constructionSystemMasterDynamicTypeValueControl',
		['_', '$compile', 'constructionSystemMasterParameterDataService', 'cosMasterParameterFormControlChangeService', 'parameterDataTypes',
			function (_, $compile, dataService, controlChangeService, parameterDataTypes) {
