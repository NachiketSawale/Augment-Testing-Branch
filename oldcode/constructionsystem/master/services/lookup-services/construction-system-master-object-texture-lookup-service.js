...
(function (angular) {
	...
	angular.module(moduleName).factory('basicsLookupdataObjectTextureDataService', ['$q', '$http',
		function ($q, $http) {
			var options = {
				lookupModuleQualifier: 'basics.lookup.objecttexture',
	...
	angular.module(moduleName).directive('basicsLookupdataObjectTextureComboBox', ['BasicsLookupdataLookupDirectiveDefinition',
		function (BasicsLookupdataLookupDirectiveDefinition) {
			...
			return new BasicsLookupdataLookupDirectiveDefinition('combobox-edit', defaults, {
				dataProvider: 'basicsLookupdataObjectTextureDataService'
			});
		}]);
})(angular);