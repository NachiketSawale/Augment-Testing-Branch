/**
 * Created by lvy on 4/16/2018.
 */
/* global _ */
(function (angular) {
	'use strict';
	var modulename = 'constructionsystem.master';
	angular.module(modulename).factory('cosGlobalParamValueLookupService',
		['$q', '$http', 'constructionSystemMasterGlobalParameterValueDataService', 'basicsLookupdataLookupDescriptorService',
			function ($q, $http, parameterValueDataService, lookupDescriptorService) {
				...
				service.getItemByKey = function getItemByKey(key) {
					...
					if (!item) {
						var targetData = lookupDescriptorService.getData('CosGlobalParamValueLookup');
