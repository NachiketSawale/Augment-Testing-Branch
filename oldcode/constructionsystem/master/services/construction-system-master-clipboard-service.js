/**
 * Created by xsi on 2016-01-13.
 */

(function (angular) {
	'use strict';
	angular.module('constructionsystem.master').factory('constructionSystemMasterClipboardService', [
		'globals', '_',
		'boqMainClipboardService',
		...
		function (
			...
			var service = angular.extend({}, boqMainClipboardService);
