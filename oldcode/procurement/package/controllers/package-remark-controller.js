...
(function (angular) {
	...
	angular.module(moduleName).controller('procurementPackageRemarkController', ['$scope', 'platformLongtextFormControllerFactory', 'procurementPackageTranslationService',
