...
(function (angular) {
	...
	angular.module(moduleName).factory('procurementStockReconciliation2DataService',
		['procurementStockHeaderDataService', '$translate', '$q', 'PlatformMessenger', function (parentService, $translate, $q, PlatformMessenger) {
			...
			service.getList = function getList() {
				...
				list.push({
					...
					Receipt: parentItem.TotalReceipt, Consumed: parentItem.TotalConsumed, Difference: parentItem.TotalValue
				});
				list.push({
					Id: index++,
