...
(function (angular) {
	...
	angular.module('procurement.contract').factory('procurementContractWizardUpdateEstimateService',
		['$q', '$http', '$translate', 'procurementPackageDataService', 'platformModalService','prcContractHeaderUpdateEstimateService','procurementContractHeaderDataService',
			function ($q, $http, $translate, packageDataService, platformModalService,prcContractHeaderUpdateEstimateService, headerDataService) {
				...
				service.updateEstimate = function (updateOptions) {
					...
					return prcContractHeaderUpdateEstimateService.providePrcUpdateEstimate(headerDataService, updateOptions);
				};
