...
(function (angular) {
	...
	angular.module(moduleName).value('procurementRfqEmailRecipientColumnDef', {
			...
			return {
				...
				columns: [
					...
					},
					{
						id: 'cc',
						field: 'Cc',
						name: 'CC Company Email',
						name$tr$: 'procurement.rfq.bidder.cCEmail',
						width: 150,
						formatter: 'description'
					},{
						id:'contactremarks',
						field:'ContactRemarks',
	 ...
	 */
	angular.module(moduleName).controller('procurementRfqEmailRecipientController', [
		'$scope', '$timeout', 'platformGridAPI', 'basicsCommonDialogGridControllerService', 'procurementRfqEmailRecipientColumnDef', 'procurementRfqEmailRecipientService',
