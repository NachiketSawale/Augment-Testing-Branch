...
(function (angular) {
	...
	angular.module(moduleName).factory('procurementRfqTotalValidationService', procurementRfqTotalValidationService);

	procurementRfqTotalValidationService.$inject = ['_', '$http', '$q', 'basicsLookupdataLookupDescriptorService'];

	function procurementRfqTotalValidationService(_, $http, $q, basicsLookupdataLookupDescriptorService) {
		return function (dataService) {
			...
			function asyncValidateValueNet(entity, value) {
				...
				var requisitionService = _.find(parentService.getChildServices(), {name: 'procurement.rfq.requisition'});
