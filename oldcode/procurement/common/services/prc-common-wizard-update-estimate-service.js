...
(function (angular) {
	...
	angular.module('procurement.common').factory('prcCommonWizardUpdateEstimateService',
		['$q', '$http', '$translate', 'procurementPackageDataService', 'platformModalService','packageUpdateEstimateService','procurementPackageDataService',
			function ($q, $http, $translate, packageDataService, platformModalService,packageUpdateEstimateService, headerDataService) {
				...
				service.updateEstimate = function (updateOptions) {
					...
					return packageUpdateEstimateService.providePrcUpdateEstimate(headerDataService, updateOptions);
				};
