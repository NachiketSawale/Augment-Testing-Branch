( function (angular)
{
	...
	angular.module( modName ).factory( 'procurementCommonItemTextLayout', procurementCommonItemTextLayout);

	procurementCommonItemTextLayout.$inject = ['basicsLookupdataConfigGenerator'];

	function procurementCommonItemTextLayout(basicsLookupdataConfigGenerator) {
		return {
			...
			'groups': [{
				'gid': 'baseGroup',
				'attributes': ['prctexttypefk', 'textmoduletypefk']
			}],
			'overloads': {
				'prctexttypefk': {
					'grid': {
						...
						'editorOptions': {
							...
							lookupOptions: {filterKey: 'prc-req-item-text-prc-text-type-filter'}
						},
						'formatter': 'lookup',
					...
					'detail': {
						...
						'options': {
							...
							lookupOptions: {
								filterKey: 'prc-req-item-text-prc-text-type-filter'
							}
						}
					}
				},
	...
	angular.module( modName ).factory( 'procurementCommonItemTextUIStandardService',
		['platformUIStandardConfigService', 'procurementCommonTranslationService',
			'procurementCommonItemTextLayout', 'platformSchemaService', 'platformUIStandardExtentService',
