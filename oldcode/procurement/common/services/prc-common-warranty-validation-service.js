...
(function (angular) {
	...
	angular.module(moduleName).factory('procurementCommonWarrantyValidationService', procurementCommonWarrantyValidationService);

	procurementCommonWarrantyValidationService.$inject = ['_', 'platformDataValidationService', 'platformRuntimeDataService',
		'procurementCommonWarrantyDataService', '$translate', 'moment'];
	function procurementCommonWarrantyValidationService(_, platformDataValidationService, platformRuntimeDataService, procurementCommonWarrantyDataService, $translate, moment) {
		var service = {};
