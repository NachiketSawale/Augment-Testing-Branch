(function (angular) {
	...
	/**
	 * @ngdoc controller
	 * @name procurementCommonGeneralsFormController
	...
	angular.module('procurement.common').controller('procurementCommonGeneralsFormController',
		['$scope', 'procurementContextService', 'procurementCommonGeneralsDataService', 'platformDetailControllerService',
