(function (angular) {
	 ...
	 * @description
	 */
	angular.module('procurement.common').directive('prcCommonItemSpecificationHtmlEditor', ['boqMainSpecificationControllerService', 'boqMainTextComplementHelperService', 'cloudDesktopUserfontService', 'platformEditorService', '$q',
		function (boqMainSpecificationControllerService, textComplementHelperService, cloudDesktopUserfontService, platformEditorService, $q) {
			...
			template +=    'textarea-name="itemSpecificationHtmlEditor" ';
