(function (angular) {
     ...
     */
	angular.module(moduleName).controller('procurementInvoiceValidationFormController',
		['$scope', 'procurementInvoiceValidationDataService', 'procurementInvoiceDetailControllerService',
			'procurementInvoiceValidationValidationService', 'procurementInvoiceValidationUIStandardService',
