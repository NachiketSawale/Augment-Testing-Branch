...
(function (angular) {
	...
	ControlTowerModul.factory('procurementQuoteMainPowerBiDataService', ProcurementQuoteMainPowerBiDataService);
	ProcurementQuoteMainPowerBiDataService.$inject = ['mtwoControlTowerConfigurationMainService',
	...
	function ProcurementQuoteMainPowerBiDataService(mtwoControlTowerConfigurationMainService, platformDataServiceFactory,
		platformDataServiceProcessDatesBySchemeExtension, ServiceDataProcessArraysExtension,
		mtwoControlTowerConfigurationImageProcessor, procurementQuoteHeaderDataService) {
		...
		procurementQuoteHeaderDataService.registerListLoaded(function () {
			serviceContainer.service.load();
		});
		...
		function getSearchFilter() {
			return {
				CallingModule: 'procurement.quote'
			};
		}
