...
(function (angular) {
	...
	ControlTowerModul.controller('procurementQuoteMainPowerbiViewController', ProcurementQuoteMainPowerbiViewController);
	ProcurementQuoteMainPowerbiViewController.$inject = [
		'$scope',
		'$translate',
	...
	function ProcurementQuoteMainPowerbiViewController(
		$scope,
		$translate,
		procurementQuoteMainPowerBiDataService,
		platformModalService,
		...
		function loadReport() {
			var selectedItem = procurementQuoteMainPowerBiDataService.getSelected();
		...
		procurementQuoteMainPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, procurementQuoteMainPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			procurementQuoteMainPowerBiDataService.unregisterSelectionChanged(loadReport);
