...
(function (angular) {
	...
	angular.module('procurement.quote').controller('procurementQuoteUpdateMaterialController',
		['$scope', '$http', '$translate', 'platformModuleNavigationService','procurementQuoteUpdateMaterialService',
			function ($scope, $http, $translate, naviService,procurementQuoteUpdateMaterialService) {
				...
				if($scope.modalOptions.isMultiMaterial) {
					...
					procurementQuoteUpdateMaterialService.updateMaterial().then(
						function (/* res */) {
