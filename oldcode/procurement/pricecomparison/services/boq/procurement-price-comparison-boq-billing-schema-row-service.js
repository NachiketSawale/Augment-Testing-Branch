(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name procurementPriceComparisonBoqBillingSchemaRowService
	 * @function
	 * @requires platformGridAPI
	 * @description
	 * #
	 * data service of pricecomparison boq compare quote row controller
	 */
	angular.module(moduleName).factory('procurementPriceComparisonBoqBillingSchemaRowService', [
		'_', 'globals', '$q', 'platformGridAPI', 'platformDataServiceFactory', 'procurementPriceComparisonCommonService', 'procurementPriceComparisonBoqService',
		function (_, globals, $q, platformGridAPI, platformDataServiceFactory, commonService, procurementPriceComparisonBoqService) {
			var serviceOption = {
				module: angular.module(moduleName),
				serviceName: 'procurementPriceComparisonBoqBillingSchemaRowService',
				httpRead: {
					...
					initReadData: function initReadData(readData) {
						...
						readData.rfqHeaderFk = baseInfo.baseRfqId;  // get the base rfqheaderFk
						readData.compareType = commonService.constant.compareType.boqItem; // (1:Item; 2: Boq)
					}
				},
				dataProcessor: [],
				presenter: {list: {}},
				...
				modification: {multi: {}},
				translation: {
					uid: 'procurementPriceComparisonBoqBillingSchemaRowService',
			...
			service.load = function () {
				...
				procurementPriceComparisonBoqService.getCustomSettingsCompareBillingSchemaRowsAsync().then(function (compareBillingSchemaRows) {
					var itemList = compareBillingSchemaRows || [];
