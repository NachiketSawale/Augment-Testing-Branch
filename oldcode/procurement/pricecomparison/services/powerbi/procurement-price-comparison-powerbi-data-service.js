...
(function (angular) {
	...
	ControlTowerModul.factory('procurementPriceComparisonMainPowerBiDataService', ProcurementPriceComparisonMainPowerBiDataService);
	ProcurementPriceComparisonMainPowerBiDataService.$inject = ['mtwoControlTowerConfigurationMainService',
	...
	function ProcurementPriceComparisonMainPowerBiDataService(mtwoControlTowerConfigurationMainService, platformDataServiceFactory,
		platformDataServiceProcessDatesBySchemeExtension, ServiceDataProcessArraysExtension,
		mtwoControlTowerConfigurationImageProcessor, procurementPriceComparisonMainService) {
		...
		procurementPriceComparisonMainService.registerListLoaded(function () {
			serviceContainer.service.load();
		});
		...
		function getSearchFilter() {
			return {
				CallingModule: 'procurement.pricecomparison'
			};
		}
