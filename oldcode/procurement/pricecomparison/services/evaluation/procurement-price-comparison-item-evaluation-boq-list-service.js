...
(function (angular) {
	...
	angular.module(moduleName).factory('procurementPriceComparisonItemEvaluationBoqListService', ['_', 'platformDataServiceFactory',
		'procurementPriceComparisonItemEvaluationService',
		function(_, platformDataServiceFactory, itemEvaluationService) {

			let serviceOption = {
				module: angular.module(moduleName),
				serviceName: 'procurementPriceComparisonItemEvaluationBoqListService',
				httpRead: {
					route: globals.webApiBaseUrl + 'procurement/pricecomparison/boq/',
					endRead: 'boqItems4wizarditemevaluation',
					usePostForRead: true,
				...
				presenter: {
					list: {
						incorporateDataRead: function(readData, data) {
							...
							itemEvaluationService.selectedBoqItems(readData);
