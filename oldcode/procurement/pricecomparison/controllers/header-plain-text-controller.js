...
(function (angular) {
	...
	/**
	 * @ngdoc controller
	 * @name headerPlainTextController
	 ...
	 */
	/* jshint -W072 */
	angular.module(moduleName).controller('procurementPriceComparisonHeaderPlainTextController', [
		'$scope', '$http', '$timeout', 'platformGridControllerService', 'procurementCommonHeaderTextUIStandardService',
		'procurementCommonHeaderTextValidationService', 'procurementPriceComparisonHeaderPlainTextService',
