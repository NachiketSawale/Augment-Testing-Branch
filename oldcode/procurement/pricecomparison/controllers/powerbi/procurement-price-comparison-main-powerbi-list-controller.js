...
(function (angular) {
	...
	angular.module(moduleName).controller('procurementPriceComparisonMainPowerBiListController', ProcurementPriceComparisonMainPowerBiListController);

	ProcurementPriceComparisonMainPowerBiListController.$inject = [
		'$scope',
	...
	function ProcurementPriceComparisonMainPowerBiListController(
		$scope,
		platformGridControllerService,
		procurementPriceComparisonMainPowerBiDataService,
		mtwoControlTowerConfigurationItemConfigurationService,
		...
		var myGridConfig = {
			...
			cellChangeCallBack: function (arg) {
				procurementPriceComparisonMainPowerBiDataService.markItemAsModified(arg.item);
			}
		};



		$scope.isLiveChanged = procurementPriceComparisonMainPowerBiDataService.isLiveChanged;
		...
		platformGridControllerService.initListController($scope,uiConfigService, procurementPriceComparisonMainPowerBiDataService, mtwoControlTowerConfigurationValidationService, myGridConfig);
