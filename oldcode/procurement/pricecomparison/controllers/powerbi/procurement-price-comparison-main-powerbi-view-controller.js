...
(function (angular) {
	...
	ControlTowerModul.controller('procurementPriceComparisonMainPowerbiViewController', ProcurementPriceComparisonMainPowerbiViewController);
	ProcurementPriceComparisonMainPowerbiViewController.$inject = [
		'$scope',
		'$translate',
		'procurementPriceComparisonMainPowerBiDataService',
	...
	function ProcurementPriceComparisonMainPowerbiViewController(
		$scope,
		$translate,
		procurementPriceComparisonMainPowerBiDataService,
		platformModalService,
		...
		function loadReport() {
			var selectedItem = procurementPriceComparisonMainPowerBiDataService.getSelected();
		...
		procurementPriceComparisonMainPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, procurementPriceComparisonMainPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			procurementPriceComparisonMainPowerBiDataService.unregisterSelectionChanged(loadReport);
