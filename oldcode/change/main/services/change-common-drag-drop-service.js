...
(function (angular) {
	...
	angular.module(moduleName).factory('changeCommonDragDropService', changeCommonDragDropService);

	changeCommonDragDropService.$inject = ['$injector'];

	function changeCommonDragDropService($injector) {
		let service = {};
