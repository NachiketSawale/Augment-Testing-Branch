...
(function (angular) {
	...
	ControlTowerModul.factory('changeMainPowerBiDataService', ChangeMainPowerBiDataService);
	ChangeMainPowerBiDataService.$inject = ['mtwoControlTowerConfigurationMainService',
	...
	function ChangeMainPowerBiDataService(mtwoControlTowerConfigurationMainService, platformDataServiceFactory,
	                                    platformDataServiceProcessDatesBySchemeExtension, ServiceDataProcessArraysExtension,
	                                    mtwoControlTowerConfigurationImageProcessor,changeMainService) {
		...
		changeMainService.registerListLoaded(function (data) {
			serviceContainer.service.load();
		});
