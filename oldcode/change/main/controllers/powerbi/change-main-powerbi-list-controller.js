...
(function (angular) {
	...
	angular.module(moduleName).controller('changeMainPowerBiListController', ChangeMainPowerBiListController);

	ChangeMainPowerBiListController.$inject = [
		'$scope',
	...
	function ChangeMainPowerBiListController(
		$scope,
		platformGridControllerService,
		changeMainPowerBiDataService,
		mtwoControlTowerConfigurationItemConfigurationService,
