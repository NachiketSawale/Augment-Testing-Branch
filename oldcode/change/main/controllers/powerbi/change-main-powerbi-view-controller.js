...
(function (angular) {
	...
	ControlTowerModul.controller('changeMainPowerbiViewController', ProjectMainPowerbiViewController);
	ProjectMainPowerbiViewController.$inject = [
		'$scope',
		'$translate',
		'changeMainPowerBiDataService',
	...
	function ProjectMainPowerbiViewController(
		...
		function loadReport() {
			var selectedItem = changeMainPowerBiDataService.getSelected();
		...
		changeMainPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, changeMainPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			changeMainPowerBiDataService.unregisterSelectionChanged(loadReport);
