(function () {
	...
	angular.module(moduleName).controller('controllingStructurePesTotalListController',[
		'$scope','platformGridControllerService','controllingStructurePesTotalUIStandardService','controllingStructurePesTotalDataService',
