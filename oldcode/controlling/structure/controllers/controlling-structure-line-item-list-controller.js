(function () {
	...
	angular.module(moduleName).controller('controllingStructureLineItemListController',[
		'$scope','platformGridControllerService','controllingStructureLineItemUIStandardService','controllingStructureLineItemDataService',
