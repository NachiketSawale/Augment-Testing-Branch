...
(function (angular) {
	...
	/**
	 * @ngdoc controller
	 * @name defectAiEstimateDurationController
	 * @function
	 *
	 * @description
	 * defectAiEstimateDurationController
	 */
	/* jshint -W072 */ // many parameters because of dependency injection
	angular.module(moduleName).controller('defectAiEstimateDurationController', [
		'globals',
		'_',
		'$scope',
		'$http',
		'$translate',
		'platformGridAPI',
		'defectAiEstimateDurationService',
		'basicsLookupdataLookupDescriptorService',
		'basicsCharacteristicTypeHelperService',
		'defectAiEstimateDurationUIStandardService',
		...
		function (globals,_,
			...
			defectAiEstimateDurationService.busyStatusChanged.register(busyStatusChanged);
			...
			angular.extend($scope.modalOptions, {
				headerText: $translate.instant('defect.main.aiWizard.durationPrediction'),
			...
			function onSelectedRowsChanged() {
				...
				if (selectedItems && selectedItems.length > 0) {
					...
					defectAiEstimateDurationService.setSelectedId($scope.selectedItem.Id);
				}
			}
