...
(function (angular) {
	...
	ControlTowerModul.controller('defectMainPowerbiViewController', DefectMainPowerbiViewController);
	DefectMainPowerbiViewController.$inject = [
		'$scope',
		'$translate',
		'defectMainPowerBiDataService',
	...
	function DefectMainPowerbiViewController(
		$scope,
		$translate,
		defectMainPowerBiDataService,
		platformModalService,
		...
		function loadReport() {
			var selectedItem = defectMainPowerBiDataService.getSelected();
		...
		defectMainPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, defectMainPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			defectMainPowerBiDataService.unregisterSelectionChanged(loadReport);
