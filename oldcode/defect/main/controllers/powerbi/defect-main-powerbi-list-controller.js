...
(function (angular) {
	...
	angular.module(moduleName).controller('defectMainPowerBiListController', DefectMainPowerBiListController);

	DefectMainPowerBiListController.$inject = [
		'$scope',
	...
	function DefectMainPowerBiListController(
		$scope,
		platformGridControllerService,
		defectMainPowerBiDataService,
		mtwoControlTowerConfigurationItemConfigurationService,
		...
		var myGridConfig = {
			...
			cellChangeCallBack: function (arg) {
				defectMainPowerBiDataService.markItemAsModified(arg.item);
			}
		};



		$scope.isLiveChanged = defectMainPowerBiDataService.isLiveChanged;
		...
		platformGridControllerService.initListController($scope,uiConfigService, defectMainPowerBiDataService, mtwoControlTowerConfigurationValidationService, myGridConfig);
