...
(function (angular) {
     ...
     */
	angular.module(moduleName).factory('estimateAssembliesConfigurationExtendService', [
		...
		function (estimateCommonDynamicConfigurationServiceFactory) {
			...
			let service = estimateCommonDynamicConfigurationServiceFactory.getService('estimateAssembliesConfigurationService', 'estimateAssembliesValidationService', options);
