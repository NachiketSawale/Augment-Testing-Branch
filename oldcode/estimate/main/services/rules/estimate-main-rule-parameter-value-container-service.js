...
(function () {
	...
	/**
	 * @ngdoc service
	 * @name estimateMainRuleParameterValueContainerService
	 * @function
	 *
	 * @description
	 *
	...
	angular.module('estimate.main').service('estimateMainRuleParameterValueContainerService', EstimateMainRuleParameterValueContainerService );

	EstimateMainRuleParameterValueContainerService.$inject = ['_', '$injector', 'platformModuleInitialConfigurationService', 'platformTranslateService',
		'platformUIStandardExtentService'];

	function EstimateMainRuleParameterValueContainerService(_, $injector, platformModuleInitialConfigurationService, platformTranslateService,
		platformUIStandardExtentService) {
		let self = this;
		...
		this.prepareConfig = function prepareConfig(containerUid, scope, modConf, additionalConfig) {
			...
			conf.dataServiceName = $injector.get('estimateMainRuleParameterValueDataServiceFactory');
			conf.validationServiceName = $injector.get('estimateMainRuleParameterValueValidationService');
