...
(function (angular) {
	...
	angular.module(moduleName).factory('estimateMainStructureValidationService',['$translate','platformDataValidationService',
		'estimateMainStructureConfigDetailDataService','estimateMainDialogDataService','platformRuntimeDataService',
