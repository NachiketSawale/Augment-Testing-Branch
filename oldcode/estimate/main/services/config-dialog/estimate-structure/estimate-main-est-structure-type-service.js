...
(function () {
	 ...
	 */
	angular.module(modulename).factory('estimateMainEstStructureTypeService', ['$q', '$http',
		function ($q, $http) {
			...
			service.loadData = function () {
				return $http.post(globals.webApiBaseUrl + 'basics/customize/eststructuretype/list')
