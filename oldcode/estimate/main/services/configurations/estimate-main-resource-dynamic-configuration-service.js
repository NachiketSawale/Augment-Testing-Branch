...
(function (angular) {
	...
	/**
     * @ngdoc service
     * @name estimateMainResourceDynamicConfigurationService
     * @function
     *
     * @description
     * estimateMainResourceDynamicConfigurationService is the config service for estimate line items container.
     */
	angular.module(moduleName).factory('estimateMainResourceDynamicConfigurationService', [
		...
		function (_, estimateCommonDynamicConfigurationServiceFactory) {
			...
			let service = estimateCommonDynamicConfigurationServiceFactory.getService('estimateMainResourceConfigurationService', 'estimateMainResourceValidationService', options);
