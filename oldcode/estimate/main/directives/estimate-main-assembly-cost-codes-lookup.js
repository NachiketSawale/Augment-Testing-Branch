...
(function(angular) {
     ...
     */
	angular.module(moduleName).directive('estimateMainAssemblyCostCodesLookup', ['$q', '$injector', 'estimateMainCostCodesLookupService',
		function ($q, $injector, estimateMainCostCodesLookupService) {

			return estimateMainCostCodesLookupService.getLookupForAssemblyDefinition();
		}
	]);
})(angular);
