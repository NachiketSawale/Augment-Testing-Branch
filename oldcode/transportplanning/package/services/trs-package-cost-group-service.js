...
(function (angular) {
	...
	angular.module(moduleName).factory('trsPackageCostGroupService', ['$injector',
		...
		function ($injector,
			...
			var parentService = dataServiceFactory.getService('TrsPackageFk', 'transportplanning.package.event', productionplanningItemDataService);
			...
			var service = $injector.get('basicsCostGroupDataServiceFactory').createService('TrsPackage', parentService, createOptions);
