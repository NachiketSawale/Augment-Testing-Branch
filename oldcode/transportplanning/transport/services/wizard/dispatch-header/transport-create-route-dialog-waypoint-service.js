...
(function (angular) {
	...
	angular.module(moduleName).service('transportplanningTransportCreateRouteWaypointService', WaypointService);

	WaypointService.$inject = ['$injector',
		'platformDataServiceFactory'];

	function WaypointService($injector, platformDataServiceFactory) {
		var data = {};
		var service = {};

		var defaultOption = {
			module: moduleName,
			serviceName: 'transportplanningTransportCreateRouteWaypointService',
			dataProcessor: [],
