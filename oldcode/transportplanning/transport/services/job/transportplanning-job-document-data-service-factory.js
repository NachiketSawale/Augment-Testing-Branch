(function (angular) {
	...
	angular.module(module).factory('transportPlanningJobDocumentDataServiceFactory', TransportPlanningJobDocumentDataServiceFactory);
	TransportPlanningJobDocumentDataServiceFactory.$inject = ['$q', 'platformDataServiceFactory',
		'platformPermissionService', 'basicsCommonFileDownloadService'];

	function TransportPlanningJobDocumentDataServiceFactory($q, platformDataServiceFactory,
