...
(function () {
	...
	angular.module(moduleName).factory('transportplanningRequisitionUIReadonlyService', UIReadonlyService);

	UIReadonlyService.$inject = ['transportplanningRequisitionUIStandardService'];
