...
(function (angular) {
	...
	angular.module(moduleName).controller('hsqeCheckListActivityDetailController',
		['$scope', 'platformDetailControllerService', 'hsqeCheckListActivityDataService', 'hsqeCheckListActivityUIStandardService', 'hsqeCheckListActivityValidationService',
