...
(function (angular) {
	...
	/*globals powerbi,$,_*/
	/**
	 * @name projectInfoRequestPowerbiViewController
	 * @function
	 */
	...
	ControlTowerModul.controller('projectInfoRequestPowerbiViewController', ProjectInfoRequestPowerbiViewController);
	ProjectInfoRequestPowerbiViewController.$inject = [
		'$scope',
		'$translate',
	...
	function ProjectInfoRequestPowerbiViewController(
		$scope,
		$translate,
		projectInfoRequestPowerBiDataService,
		platformModalService,
		...
		function loadReport() {
			var selectedItem = projectInfoRequestPowerBiDataService.getSelected();
		...
		projectInfoRequestPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, projectInfoRequestPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			projectInfoRequestPowerBiDataService.unregisterSelectionChanged(loadReport);
