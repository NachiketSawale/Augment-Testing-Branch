...
(function (angular) {
	...
	ControlTowerModul.factory('projectInfoRequestPowerBiDataService', projectInfoRequestPowerBiDataService);
	projectInfoRequestPowerBiDataService.$inject = ['mtwoControlTowerConfigurationMainService',
	...
	function projectInfoRequestPowerBiDataService(mtwoControlTowerConfigurationMainService, platformDataServiceFactory,
	                                    platformDataServiceProcessDatesBySchemeExtension, ServiceDataProcessArraysExtension,
	                                    mtwoControlTowerConfigurationImageProcessor,projectInfoRequestDataService) {
		...
		projectInfoRequestDataService.registerListLoaded(function () {
			serviceContainer.service.load();
		});
		...
		function getSearchFilter(){
			return {
				CallingModule: 'project.inforequest'
			};
		}
