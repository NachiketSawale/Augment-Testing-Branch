(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name projectInfoRequestDynamicConfigurationServiceFactory
	 * @function
	 *
	 * @description
	...
	angular.module(moduleName).factory('projectInfoRequestDynamicConfigurationServiceFactory', [
		...
		function ($injector, PlatformMessenger, mainViewService, platformGridAPI, platformGridControllerService, platformTranslateService, basicsCostGroupAssignmentService, basicsCommonChangeColumnConfigService) {
			...
			function createNewComplete(standardConfigurationService, validationService, options) {
				...
				angular.extend(service, {
					...
					getStandardConfigForProjectInfoRequestStructure: getStandardConfigForProjectInfoRequestStructure,
				...
				function getStandardConfigForProjectInfoRequestStructure(){
			...
			return {
				...
				getService: function (projectInfoRequestUIStandardService, validationService, options) {
					return createNewComplete(projectInfoRequestUIStandardService, validationService, options);
				},
				createService: function (projectInfoRequestUIStandardService, validationService, options) {
					return createNewComplete(projectInfoRequestUIStandardService, validationService, options);
				}
			};
