...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name projectPlantAssemblyConfigurationExtendService
	 * @function
	 *
	 * @description
	 * projectPlantAssemblyConfigurationExtendService is the config service for project plant assemblies container.
	 */
	angular.module(moduleName).factory('projectPlantAssemblyConfigurationExtendService', [
		...
		function (_, estimateCommonDynamicConfigurationServiceFactory) {
			...
			let service = estimateCommonDynamicConfigurationServiceFactory.getService('projectPlantassemblyStandardConfigurationService', 'projectPlantAssemblyValidationService', {
				groupName : 'basicData',
				uuid: 'c163031647d6459288c5c43ed46cf6e8'
			});
