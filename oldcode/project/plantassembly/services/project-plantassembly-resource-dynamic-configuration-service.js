/**
 * Created by winjit.juily.deshkar on 19/01/2024.
 */
...
(function (angular) {
	...
	/**
     * @ngdoc service
     * @name projectPlantAssemblyResourceDynamicConfigurationService
     * @function
     *
     * @description
     * projectPlantAssemblyResourceDynamicConfigurationService is the config service for project assembly resources container.
     */
	angular.module(moduleName).factory('projectPlantAssemblyResourceDynamicConfigurationService', [
		...
		function (estimateCommonDynamicConfigurationServiceFactory) {
			...
			let service = estimateCommonDynamicConfigurationServiceFactory.getService('projectPlantAssemblyResourceConfigurationService', 'projectPlantAssemblyResourceValidationService', options);

			let originalGetStandardConfigForDetailView = service.getStandardConfigForDetailView;
			...
			service.getStandardConfigForDetailView = function(){
				...
				let configForDetail = originalGetStandardConfigForDetailView();
