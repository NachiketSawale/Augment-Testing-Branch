...
(function (angular) {
	...
	/**
     * @ngdoc service
     * @name projectPlantAssembliesResourceDynamicConfigurationService
     * @function
     */
	angular.module(moduleName).factory('projectPlantAssembliesResourceDynamicConfigurationService', [
