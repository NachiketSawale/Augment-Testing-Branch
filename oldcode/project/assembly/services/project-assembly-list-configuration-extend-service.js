...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name projectAssembliesConfigurationExtendService
	 * @function
	 *
	 * @description
	 * estimateMainDynamicConfigurationService is the config service for estimate line items container.
	 */
	angular.module(moduleName).factory('projectAssembliesConfigurationExtendService', [
		...
		function (_, estimateCommonDynamicConfigurationServiceFactory) {
			...
			let service = estimateCommonDynamicConfigurationServiceFactory.getService('projectAssemblyUIConfigurationService', 'projectAssemblyValidationService', {groupName : 'basicData'});
