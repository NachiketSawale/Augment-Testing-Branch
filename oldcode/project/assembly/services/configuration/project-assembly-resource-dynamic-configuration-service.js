...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name projectAssembliesResourceDynamicConfigurationService
	 * @function
	 */
	angular.module(moduleName).factory('projectAssembliesResourceDynamicConfigurationService', [
		...
		function (estimateCommonDynamicConfigurationServiceFactory) {
			...
			let service = estimateCommonDynamicConfigurationServiceFactory.getService('projectAssemblyResourceConfigurationService', 'projectAssemblyResourceValidationService', options);
