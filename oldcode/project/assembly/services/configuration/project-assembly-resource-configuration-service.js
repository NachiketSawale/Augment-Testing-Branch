(function () {
	...
	// Layout specs
	angular.module(moduleName).value('projectAssemblyResourceDetailLayout', {
		'fid': 'project.assembly.resource.detailform',
		'version': '1.0.0',
	...
	angular.module(moduleName).factory('projectAssemblyResourceConfigurationService',
			...
			function ($log, platformUIStandardConfigService, platformSchemaService, estimateAssembliesTranslationService, estimateAssembliesResourceDetailLayout, estimateMainUIConfigurationService, platformUIStandardExtentService) {
				...
				function getResourceDetailLayout() {
					...
					if (_.has(estimateAssembliesResourceDetailLayout.overloads, codeEditorOptionsPath)) {
						_.set(estimateAssembliesResourceDetailLayout.overloads, codeEditorOptionsPath + '.usageContext', 'projectAssemblyResourceService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, codeEditorOptionsPath + '.lookupOptions.filterAssemblyKey', 'estimate-main-resources-prj-assembly-priority-filter');
						_.set(estimateAssembliesResourceDetailLayout.overloads, codeEditorOptionsPath + '.lookupOptions.filterPrjAssemblyKey', 'project-assembly-resources-prj-assembly-priority-filter');
						_.set(estimateAssembliesResourceDetailLayout.overloads, codeEditorOptionsPath + '.lookupOptions.userDefinedConfigService', 'projectAssemblyResourceDynamicUserDefinedColumnService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, codeDetailOptionsPath + '.usageContext', 'projectAssemblyResourceService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, descriptionEditorOptionsPath + '.usageContext', 'projectAssemblyResourceService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, descriptionEditorOptionsPath + '.lookupOptions.filterAssemblyKey', 'estimate-main-resources-prj-assembly-priority-filter');
						_.set(estimateAssembliesResourceDetailLayout.overloads, descriptionEditorOptionsPath + '.lookupOptions.filterPrjAssemblyKey', 'project-assembly-resources-prj-assembly-priority-filter');
						_.set(estimateAssembliesResourceDetailLayout.overloads, descriptionEditorOptionsPath + '.lookupOptions.userDefinedConfigService', 'projectAssemblyResourceDynamicUserDefinedColumnService');

						_.set(estimateAssembliesResourceDetailLayout.overloads, descriptionDetailOptionsPath + '.usageContext', 'projectAssemblyResourceService');
