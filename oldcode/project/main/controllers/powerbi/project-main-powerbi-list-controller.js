...
(function (angular) {
	...
	angular.module(moduleName).controller('projectMainPowerBiListController', ProjectMainPowerBiListController);

	ProjectMainPowerBiListController.$inject = [
		'$scope',
	...
	function ProjectMainPowerBiListController(
		$scope,
		platformGridControllerService,
		changeMainPowerBiDataService,
		mtwoControlTowerConfigurationItemConfigurationService,
		...
		var myGridConfig = {
			...
			cellChangeCallBack: function (arg) {
				changeMainPowerBiDataService.markItemAsModified(arg.item);
			}
		};



		$scope.isLiveChanged = changeMainPowerBiDataService.isLiveChanged;
		...
		platformGridControllerService.initListController($scope,uiConfigService, changeMainPowerBiDataService, mtwoControlTowerConfigurationValidationService, myGridConfig);
