...
(function (angular) {
	...
	ControlTowerModul.controller('projectMainPowerbiViewController', ProjectMainPowerbiViewController);
	ProjectMainPowerbiViewController.$inject = [
		'$scope',
		'$translate',
		'projectMainPowerBiDataService',
	...
	function ProjectMainPowerbiViewController(
		$scope,
		$translate,
		projectMainPowerBiDataService,
		platformModalService,
		...
		function loadReport() {
			var selectedItem = projectMainPowerBiDataService.getSelected();
		...
		projectMainPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, projectMainPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			projectMainPowerBiDataService.unregisterSelectionChanged(loadReport);
