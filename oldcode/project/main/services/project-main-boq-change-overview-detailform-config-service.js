(function (angular) {
     ...
     * @description
     */
	angular.module(modulename).factory('prjBoqChangeOverviewDetailFormConfigService', [ '$injector', 'basicsLookupdataConfigGenerator', 'platformSchemaService', 'PlatformMessenger', 'boqMainCommonService',
		...
		function ($injector, basicsLookupdataConfigGenerator, platformSchemaService, PlatformMessenger, boqMainCommonService,
			...
			function FormConfig(option) {
				...
				self.groups = [
					{
						gid: 'BasicData',
						attributes: [ 'reference', 'briefinfo','f','contractcode','prjchangeid', 'prjchangestatusid', 'boqrootitemreference', 'bidcode']
					},
					{
						gid: 'QuantityPrice',
