...
(function (angular) {
	...
	ControlTowerModul.factory('projectMainPowerBiDataService', ProjectMainPowerBiDataService);
	ProjectMainPowerBiDataService.$inject = ['mtwoControlTowerConfigurationMainService',
	...
	function ProjectMainPowerBiDataService(mtwoControlTowerConfigurationMainService, platformDataServiceFactory,
	                                    platformDataServiceProcessDatesBySchemeExtension, ServiceDataProcessArraysExtension,
	                                    mtwoControlTowerConfigurationImageProcessor,projectMainService) {
		...
		mtwoControlTowerConfigurationMainService.onUpdateItems.register(function (data) {
			serviceContainer.service.load();
		});
		projectMainService.registerListLoaded(function (data) {
			serviceContainer.service.load();
		});
