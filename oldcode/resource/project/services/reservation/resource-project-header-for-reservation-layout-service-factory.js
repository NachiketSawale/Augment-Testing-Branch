...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name resourceProjectHeaderForReservationLayoutServiceFactory
	 * @description creates data services used in different reserved for to container
	 */
	angular.module(moduleName).service('resourceProjectHeaderForReservationLayoutServiceFactory', ResourceProjectHeaderForReservationLayoutServiceFactory);

	ResourceProjectHeaderForReservationLayoutServiceFactory.$inject = ['_', '$injector', 'resourceProjectHeaderForReservationDataServiceFactory'];

	function ResourceProjectHeaderForReservationLayoutServiceFactory(_, $injector, resourceProjectHeaderForReservationDataServiceFactory) {
		let instances = {};
		...
		this.createConfig = function createConfig(templUid, templInfo) {
			...
			conf.dataServiceName = resourceProjectHeaderForReservationDataServiceFactory.createDataService(templInfo);
