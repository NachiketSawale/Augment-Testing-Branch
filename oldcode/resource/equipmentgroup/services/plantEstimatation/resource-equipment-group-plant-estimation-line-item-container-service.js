...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name resourceEquipmentGroupPlantEstimationLineItemContainerService
	 * @function
	 *
	 * @description
	 *
	 */
	plantGroupModule.service('resourceEquipmentGroupPlantEstimationLineItemContainerService', ResourceEquipmentGroupPlantEstimationLineItemContainerService);

	ResourceEquipmentGroupPlantEstimationLineItemContainerService.$inject = ['_', '$injector', 'platformModuleInitialConfigurationService', 'platformTranslateService',
		'projectCommonLayoutOverloadService', 'resourceEquipmentGroupPlantEstimationLineItemDataService', 'estimateAssembliesValidationService'];

	function ResourceEquipmentGroupPlantEstimationLineItemContainerService(_, $injector, platformModuleInitialConfigurationService, platformTranslateService,
		projectCommonLayoutOverloadService, resourceEquipmentGroupPlantEstimationLineItemDataService, estimateAssembliesValidationService) {
		let self = this;
		...
		this.prepareConfig = function prepareConfig(containerUid, scope, modConf) {
			let options = {isPlantAssembly:true,
				assemblyConfigExtendServiceName:'resourceEquipmentGroupConfigurationExtendService',
				assemblyResourceDataServiceName: 'resourceEquipmentGroupPlantEstimationResourceDataService',
				assemblyDataServiceName:'resourceEquipmentGroupPlantEstimationLineItemDataService',
				assemblyValidationServiceName:'resourceEquipmentGroupEstimateAssemblyValidationService',
			...
			conf.dataServiceName = resourceEquipmentGroupPlantEstimationLineItemDataService;
			conf.standardConfigurationService = getConfigurationService(conf);
			conf.validationServiceName = estimateAssembliesValidationService;
