...
(function () {
	...
	/**
	 * @ngdoc service
	 * @name resourceEquipmentGroupEstimateResourceConfigurationService
	 * @function
	 *
	 * @description
	 * This is the config service for all plant group assembly's Reesource views.
	 */
	angular.module(moduleName).factory('resourceEquipmentGroupEstimateResourceConfigurationService',
			...
			function ($log, platformUIStandardConfigService, platformSchemaService, estimateAssembliesTranslationService, estimateAssembliesResourceDetailLayout, estimateMainUIConfigurationService, platformUIStandardExtentService) {
				...
				function getResourceDetailLayout() {
					...
					if (_.has(estimateAssembliesResourceDetailLayout.overloads, codeEditorOptionsPath)) {
						_.set(estimateAssembliesResourceDetailLayout.overloads, codeEditorOptionsPath + '.usageContext', 'resourceEquipmentGroupPlantEstimationResourceDataService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, codeEditorOptionsPath + '.lookupOptions.plantAssembliesService', 'resourceEquipmentGroupPlantEstimationLineItemDataService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, codeDetailOptionsPath + '.usageContext', 'resourceEquipmentGroupPlantEstimationResourceDataService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, codeDetailOptionsPath + '.lookupOptions.plantAssembliesService', 'resourceEquipmentGroupPlantEstimationLineItemDataService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, descriptionEditorOptionsPath + '.usageContext', 'resourceEquipmentGroupPlantEstimationResourceDataService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, descriptionEditorOptionsPath + '.lookupOptions.plantAssembliesService', 'resourceEquipmentGroupPlantEstimationLineItemDataService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, descriptionDetailOptionsPath + '.usageContext', 'resourceEquipmentGroupPlantEstimationResourceDataService');
						...
						_.set(estimateAssembliesResourceDetailLayout.overloads, descriptionDetailOptionsPath + '.lookupOptions.plantAssembliesService', 'resourceEquipmentGroupPlantEstimationLineItemDataService');
					}
