...
(function (angular) {
	...
	/**
	 * @ngdoc directive
	 * @name resourceMasterResourceLookupDialogNew
	 * @requires LookupFilterDialogDefinition, basicsLookupdataConfigGenerator
	 * @description ComboBox to select a activity template
	 */

	angular.module('resource.master').directive('resourceMasterResourceLookupDialogNew', ['LookupFilterDialogDefinition', 'basicsLookupdataConfigGenerator',
		...
		function (LookupFilterDialogDefinition, basicsLookupdataConfigGenerator,
			...
			var lookupOptions = {
				...
				uuid: 'aa75db0e842b4679a1d50608c04ab496'
			};
