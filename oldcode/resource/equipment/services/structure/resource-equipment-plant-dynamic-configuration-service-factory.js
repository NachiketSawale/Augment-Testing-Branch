/**
 * Created by cakiral on 22/01/2021.
 */
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name resourceEquipmentPlantDynamicConfigurationServiceFactory
	 * @function
	 *
	 * @description
	...
	angular.module(moduleName).factory('resourceEquipmentPlantDynamicConfigurationServiceFactory', [
		...
		function ($injector, PlatformMessenger, mainViewService, platformGridAPI, platformGridControllerService, platformTranslateService, basicsCostGroupAssignmentService, basicsCommonChangeColumnConfigService) {
			...
			function createNewComplete(standardConfigurationService, validationService, options) {
				...
				angular.extend(service, {
					...
					getStandardConfigForResourceEquipmentPlantStructure: getStandardConfigForResourceEquipmentPlantStructure,
				...
				function getStandardConfigForResourceEquipmentPlantStructure(){
			...
			return {
				...
				getService: function (resourceEquipmentPlantUIStandardService, validationService, options) {
					return createNewComplete(resourceEquipmentPlantUIStandardService, validationService, options);
				},
				createService: function (resourceEquipmentPlantUIStandardService, validationService, options) {
					return createNewComplete(resourceEquipmentPlantUIStandardService, validationService, options);
				}
			};
