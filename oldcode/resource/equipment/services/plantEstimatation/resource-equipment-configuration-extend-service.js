...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name resourceEquipmentConfigurationExtendService
	 * @function
	 *
	 * @description
	 * resourceEquipmentConfigurationExtendService is the config service for resource equipment assemblies container.
	 */
	angular.module(moduleName).factory('resourceEquipmentConfigurationExtendService', [
		...
		function (_, estimateCommonDynamicConfigurationServiceFactory) {
			...
			let service = estimateCommonDynamicConfigurationServiceFactory.getService('resourceEquipmentEstimateAssemblyUIConfigurationService', 'resourceEquipmentEstimateAssemblyValidationService', {groupName : 'basicData'});
