...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name resourceEnterpriseHeaderForReservationLayoutServiceFactory
	 * @description creates data services used in different reserved for to container
	 */
	angular.module(moduleName).service('resourceEnterpriseHeaderForReservationLayoutServiceFactory', ResourceEnterpriseHeaderForReservationLayoutServiceFactory);

	ResourceEnterpriseHeaderForReservationLayoutServiceFactory.$inject = ['_', '$injector', 'resourceEnterpriseHeaderForReservationDataServiceFactory'];

	function ResourceEnterpriseHeaderForReservationLayoutServiceFactory(_, $injector, resourceEnterpriseHeaderForReservationDataServiceFactory) {
		let instances = {};
		...
		this.createConfig = function createConfig(templUid, templInfo) {
			...
			conf.dataServiceName = resourceEnterpriseHeaderForReservationDataServiceFactory.createDataService(templInfo);
