...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name resourceRequisitionDynamicConfigurationServiceFactory
	 * @function
	 *
	 * @description
	...
	angular.module(moduleName).factory('resourceRequisitionDynamicConfigurationServiceFactory', [
		...
		function ($injector, PlatformMessenger, mainViewService, platformGridAPI, platformGridControllerService, platformTranslateService, basicsCostGroupAssignmentService, basicsCommonChangeColumnConfigService) {
			...
			function createNewComplete(standardConfigurationService, validationService, options) {
				...
				angular.extend(service, {
					...
					getStandardConfigForResourceRequisitionStructure: getStandardConfigForResourceRequisitionStructure,
				...
				function getStandardConfigForResourceRequisitionStructure(){
			...
			return {
				...
				getService: function (resourceRequisitionUIStandardService, validationService, options) {
					return createNewComplete(resourceRequisitionUIStandardService, validationService, options);
				},
				createService: function (resourceRequisitionUIStandardService, validationService, options) {
					return createNewComplete(resourceRequisitionUIStandardService, validationService, options);
				}
			};
