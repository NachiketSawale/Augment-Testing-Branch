/**
 * $Id: resource-equipment-configuration-extend-service.js 21982 2021-12-10 16:29:21Z joshi $
...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name resourcePlantEstimateConfigurationExtendService
	 * @function
	 *
	 * @description
	 * resourcePlantEstimateConfigurationExtendService is the config service for resource equipment assemblies container.
	 */
	angular.module(moduleName).factory('resourcePlantEstimateConfigurationExtendService', [
		...
		function (_, estimateCommonDynamicConfigurationServiceFactory) {
			...
			let service = estimateCommonDynamicConfigurationServiceFactory.getService('resourcePlantEstimateAssemblyConfigurationService', 'resourcePlantEstimateAssemblyValidationService', {groupName : 'basicData'});
