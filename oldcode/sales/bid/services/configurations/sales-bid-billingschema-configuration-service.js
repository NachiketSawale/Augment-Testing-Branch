...
(function () {
	...
	angular.module(moduleName).factory('salesBidBillingSchemaConfigurationService',
		['$injector', 'platformUIStandardConfigService', 'salesBidTranslationService', 'platformSchemaService', 'basicsLookupdataConfigGenerator',
			function ($injector, platformUIStandardConfigService, salesBidTranslationService, platformSchemaService, basicsLookupdataConfigGenerator) {

				var schemasForProjectDetailLayout = {
					'fid': 'sales.bid.schemas.detailform',
					'version': '1.0.0',
					'showGrouping': true,
						...
						'controllingunitfk': {
							grid: {
								...
								editorOptions: {
									...
									lookupOptions: {
										filterKey: 'sales-bid-generals-controlling-unit-filter'
									}
								},
								'formatter': 'lookup',
				...
				return new BaseService(schemasForProjectDetailLayout, salesBillingSchema, salesBidTranslationService);
			}
		]);
})();
