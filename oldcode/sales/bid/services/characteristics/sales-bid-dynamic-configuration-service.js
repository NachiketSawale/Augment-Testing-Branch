...
(function (angular) {
	...
	angular.module(moduleName).factory('salesBidDynamicConfigurationService', [
		...
		'salesBidConfigurationService', 'salesBidValidationService',
		function (_, PlatformMessenger, platformGridAPI, platformGridControllerService, platformTranslateService, basicsCommonChangeColumnConfigService,
			...
			var baseCongigurationService = salesBidConfigurationService;

			var baseValidationService = salesBidValidationService;
