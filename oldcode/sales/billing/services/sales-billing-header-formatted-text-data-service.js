...
(function () {
	...
	/**
	 * @ngdoc service
	 * @name salesBillingHeaderFormattedTextDataService
	 * @function
	 *
	 * @description
	 * salesBillingHeaderFormattedTextDataService is the data service for the Header Formatted Text Container
	 */
	salesBillingModule.factory('salesBillingHeaderFormattedTextDataService',
		['globals', '_', '$injector', '$q', '$http', 'platformModalService', 'salesBillingService', 'platformDataServiceFactory', 'basicsCommonTextFormatConstant', 'PlatformMessenger',
			'salesCommonDataHelperService',
			function (globals, _, $injector, $q, $http, platformModalService, salesBillingService, platformDataServiceFactory, basicsCommonTextFormatConstant, PlatformMessenger,
					  salesCommonDataHelperService) {
