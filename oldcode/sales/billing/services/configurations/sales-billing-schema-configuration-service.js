...
(function () {
	...
	angular.module(moduleName).factory('salesBillingSchemaConfigurationService',
		['$injector', 'platformUIStandardConfigService', 'salesBillingTranslationService', 'platformSchemaService', 'basicsLookupdataConfigGenerator',
			function ($injector, platformUIStandardConfigService, salesBillingTranslationService, platformSchemaService, basicsLookupdataConfigGenerator) {

				var schemasForProjectDetailLayout = {
					'fid': 'sales.billing.schemas.detailform',
					'version': '1.0.0',
					'showGrouping': true,
					...
					'groups': [
						{
							...
							'attributes': ['accountno', 'sorting', 'description', 'description2', 'billinglinetypefk',
								...
								'coderetention', 'baspaymenttermfk', 'costlinetypefk','factor']
						},
						{
							'gid': 'userDefText',
							'isUserDefText': true,
						...
						'controllingunitfk': {
							grid: {
								...
								editorOptions: {
									...
									lookupOptions: {
										filterKey: 'sales-billing-generals-controlling-unit-filter'
									}
								},
								'formatter': 'lookup',
				...
				return new BaseService(schemasForProjectDetailLayout, salesBillingSchema, salesBillingTranslationService);
			}
		]);
})();
