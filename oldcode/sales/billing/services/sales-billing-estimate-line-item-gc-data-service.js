...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name salesBillingEstimateLineItemGcDataService
	 * @function
	 *
	 * @description
	 * salesBillingLineItemGcDataService is the data service for all estimate line item (gc) related functionality in the module Sales Billing.
	 */
	/* jshint -W072 */ // many parameters because of dependency injection
	/* jshint -W003 */
	angular.module(moduleName).factory('salesBillingEstimateLineItemGcDataService',
		['_', 'globals', '$http', '$rootScope', 'PlatformMessenger', 'platformDataServiceFactory', 'platformRuntimeDataService', 'salesBillingService', 'salesBillingReadonlyProcessor', '$injector', 'basicsLookupdataLookupDescriptorService', 'modelViewerModelSelectionService', 'salesBillingEstimateHeaderDataService', 'modelViewerStandardFilterService',
			function (_, globals, $http, $rootScope, PlatformMessenger, platformDataServiceFactory, platformRuntimeDataService, salesBillingService, readonlyProcessor, $injector, lookupDescriptorService, modelViewerModelSelectionService, salesBillingEstimateHeaderDataService, modelViewerStandardFilterService) {
				...
				function initReadData(readData) {
					...
					if (selectedBill) {
						...
						readData.date = selectedBill.PerformedTo;
				...
				service.getDataByHeaderId = function () {
					var selectedBilHeader = salesBillingService.getSelected();
					if (selectedBilHeader) {
						var readData = {};
