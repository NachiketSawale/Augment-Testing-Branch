...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name salesBillingResourceTypeProcessor
	 * @function
	 * @description
	 * The service to set resources type and css style and fields readonly.
	 *
	 */
	angular.module(moduleName).factory('salesBillingResourceTypeProcessor', ['_', '$injector', 'platformRuntimeDataService',
		function (_, $injector, platformRuntimeDataService) {
			...
			function processItem(resource) {
				...
				var lineItemDataService = $injector.get('salesBillingEstimateLineItemDataService');
