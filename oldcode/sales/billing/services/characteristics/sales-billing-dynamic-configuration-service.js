...
(function (angular) {
	...
	angular.module(moduleName).factory('salesBillingDynamicConfigurationService', [
		...
		'salesBillingConfigurationService', 'salesBillingValidationService',
		function (_, PlatformMessenger, platformGridAPI, platformGridControllerService, platformTranslateService, basicsCommonChangeColumnConfigService,
			...
			var baseCongigurationService = salesBillingConfigurationService;

			var baseValidationService = salesBillingValidationService;
