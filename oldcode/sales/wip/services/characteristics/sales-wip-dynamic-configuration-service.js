...
(function (angular) {
	...
	angular.module(moduleName).factory('salesWipDynamicConfigurationService', [
		...
		'salesWipConfigurationService', 'salesWipValidationService',
		function (_, PlatformMessenger, platformGridAPI, platformGridControllerService, platformTranslateService, basicsCommonChangeColumnConfigService,
			...
			var baseCongigurationService = salesWipConfigurationService;

			var baseValidationService = salesWipValidationService;
