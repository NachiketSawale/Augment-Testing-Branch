/**
 * $Id: sales-wip-header-formatted-text-data-service.js 68296 2023-01-13 14:16:02Z postic $
...
(function () {
	...
	/**
	 * @ngdoc service
	 * @name salesWipHeaderFormattedTextDataService
	 * @function
	 *
	 * @description
	 * salesWipHeaderFormattedTextDataService is the data service for the Header Formatted Text Container
	 */
	salesWipModule.factory('salesWipHeaderFormattedTextDataService',
		['globals', '_', '$injector', '$q', '$http', 'platformModalService', 'salesWipService', 'platformDataServiceFactory', 'basicsCommonTextFormatConstant', 'PlatformMessenger',
			'salesCommonDataHelperService',
			function (globals, _, $injector, $q, $http, platformModalService, salesWipService, platformDataServiceFactory, basicsCommonTextFormatConstant, PlatformMessenger,
					  salesCommonDataHelperService) {
