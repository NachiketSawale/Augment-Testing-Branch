...
(function () {
	...
	angular.module(moduleName).factory('salesWipBillingSchemaConfigurationService',
		['$injector', 'platformUIStandardConfigService', 'salesWipTranslationService', 'platformSchemaService', 'basicsLookupdataConfigGenerator',
			function ($injector, platformUIStandardConfigService, salesWipTranslationService, platformSchemaService, basicsLookupdataConfigGenerator) {

				var detailLayout = {
					'fid': 'sales.wip.schemas.detailform',
					'version': '0.1.0',
					'showGrouping': true,
						...
						'controllingunitfk': {
							grid: {
								...
								editorOptions: {
									...
									lookupOptions: {
										filterKey: 'sales-wip-generals-controlling-unit-filter'
									}
								},
								'formatter': 'lookup',
				...
				return new BaseService(detailLayout, salesBillingSchema, salesWipTranslationService);
			}
		]);
})();
