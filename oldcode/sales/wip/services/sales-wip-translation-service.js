...
(function () {
	...
	angular.module(salesWipModule).value('salesWipTranslations', {
		translationInfos: {
			'extraModules': [salesContractModule, salesWipModule, salesCommonModule, cloudCommonModule, projectMainModule, basicsCommonModule, businesspartnerMainModule, boqMainModule, basicsClerk,
				salesBillingModule, basicsUserFormModule, basicsProcurementStructureModule, qtoMainModule, procurementCommonModule,
				modelEvaluationModule, modelMainModule, modelSimulationModule, modelViewerModule, estimateMainModule],
			'extraWords': {
				userDefText: { location: cloudCommonModule, identifier: 'UserdefTexts', initial: 'User Defined Text' },

				WipStatusFk: { location: salesWipModule, identifier: 'entityWipStatusFk', initial: 'WIP Status' },
				DocumentDate: { location: salesWipModule, identifier: 'entityDocumentDate', initial: 'Document Date' },
				IsExport: { location: salesWipModule, identifier: 'entityIsExport', initial: 'Export' },
				WipCode: { location: salesWipModule, identifier: 'entityWipCode', initial: 'Wip Code' },

				PrevWipHeaderFk: { location: salesWipModule, identifier: 'previousWip', initial: 'Previous WIP' },
				...
				CredFactor: {location: basicsBillingschemaModule, identifier: 'credFactor', initial: 'Cred Factor'},
				DebFactor: {location: basicsBillingschemaModule, identifier: 'debFactor', initial: 'Deb Factor'},
				DetailAuthorAmountFk: {location: basicsBillingschemaModule, identifier: 'billingschmdtlaafk', initial: 'Author.Amount Ref'},
				BillingSchemaDetailTaxFk: {location: basicsBillingschemaModule, identifier: 'billingSchmDtlTaxFk', initial: 'Tax Ref'},
				CredLineTypeFk: {location: basicsBillingschemaModule, identifier: 'creditorlinetype', initial: 'Treatment Cred'},
				DebLineTypeFk: {location: basicsBillingschemaModule, identifier: 'debitorlinetype', initial: 'Treatment Deb'},
				IsBilled: { location: salesWipModule, identifier: 'entityIsBilled', initial: 'Is Billed' },
				IsNotAccrual: { location: salesWipModule, identifier: 'entityIsNotAccrual', initial: 'Is not accrual' },
				WipValue: { location: salesWipModule, identifier: 'entityWipValue', initial: 'WIP Value' },
				WipVat: { location: salesWipModule, identifier: 'entityWipVat', initial: 'WIP VAT' },
				WipValueOc: { location: salesWipModule, identifier: 'entityWipValueOc', initial: 'WIP Value Original Currency' },
				WipVatOc: { location: salesWipModule, identifier: 'entityWipVatOc', initial: 'WIP Vat Original Currency' },
				DateEffective:{location: 'basics.common', identifier: 'dateEffective', initial: 'Date Effective'},
				CompanyTransactionFk: { location: salesWipModule, identifier: 'entityCompanyTransactionFk', initial: 'Company Transaction'},
				...
				QtoHeaderFk: {location: salesWipModule, identifier: 'entityQtoHeaderFk', initial: 'QTO'},
				IsCanceled: {location: salesWipModule, identifier: 'entityIsCanceled', initial: 'Is Canceled'},
				FactorDJC: {location: salesWipModule, identifier: 'entityFactorDJC', initial: 'Factor on DJC'}
			}
		}
	});
	...
	var estimateMainTranslations = {
		translationInfos: {
			'extraModules': [procurementPackageModule,estimateMainModule, estimateProjectModule, cloudCommonModule, basicsCostCodesModule, basicsMaterialModule,
				...
				modelEvaluationModule, qtoMainModule],
			'extraWords': {
				...
				LiPreviousQuantity: {location: salesWipModule, identifier: 'LiPreviousQuantity', initial: 'Previous Quantity'},
				LiQuantity: {location: salesWipModule, identifier: 'LiQuantity', initial: 'Installed Quantity'},
				LiTotalQuantity: {location: salesWipModule, identifier: 'LiTotalQuantity', initial: 'Total Quantity'},
				LiPercentageQuantity: {location: salesWipModule, identifier: 'LiPercentageQuantity', initial: 'Percentage Quantity'},
				LiCumulativePercentage: {location: salesWipModule, identifier: 'LiCumulativePercentage', initial: 'Cumulative Percentage'}
			}
		}
	};
	...
	/**
	 * @ngdoc service
	 * @name salesWipTranslationService
	 * @description provides translation for sales wip module
	 */
	angular.module(salesWipModule).service('salesWipTranslationService', ['platformUIBaseTranslationService', 'salesContractTranslations', 'salesWipTranslations', 'salesCommonTranslations', 'salesWipBillingSchemaTranslations','salesWipransactionTranslations', 'salesWipValidationConfigurationService',
		'salesBillingTranslations',
		function (platformUIBaseTranslationService, salesContractTranslations, salesWipTranslations, salesCommonTranslations, salesWipBillingSchemaTranslations,salesWipransactionTranslations, salesBillingTranslations, salesWipValidationConfigurationService) {
			var localBuffer = {};
			...
			platformUIBaseTranslationService.call(this, [salesCommonTranslations, salesContractTranslations, salesWipTranslations, salesWipBillingSchemaTranslations,salesWipransactionTranslations, salesBillingTranslations, estimateMainTranslations, salesWipValidationConfigurationService], localBuffer);
		}
