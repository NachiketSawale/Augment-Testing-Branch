...
(function () {
	...
	angular.module(moduleName).factory('salesCommonWarrantyDataService', [
		...
		function (
			...
			function constructorFn(parentService, url, itemName) {
				var serviceOption = {
					flatLeafItem: {
						...
						serviceName: 'salesCommonWarrantyDataService',
						httpCRUD: {
							route: url,
			...
			return salesCommonServiceCache.registerService(constructorFn, 'salesCommonWarrantyDataService');
		}
	]);
})();