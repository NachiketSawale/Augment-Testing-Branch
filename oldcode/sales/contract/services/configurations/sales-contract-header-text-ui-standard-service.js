...
(function () {
	...
	/**
	 * @ngdoc service
	 * @name salesContractHeaderTextUIStandardService
	 * @function
	 *
	 * @description
	 * salesContractHeaderTextUIStandardService is used for header text controller
	 */
	salesContractModule.factory('salesContractHeaderTextUIStandardService', ['platformUIStandardConfigService', 'platformSchemaService', 'salesContractTranslationService', 'platformUIStandardExtentService', 'basicsLookupdataConfigGenerator',
		function (platformUIStandardConfigService, platformSchemaService, salesContractTranslationService, platformUIStandardExtentService, basicsLookupdataConfigGenerator) {

			var salesContractHeaderTextLayout = {
				'version': '1.0.0',
			...
			var service = new BaseService(salesContractHeaderTextLayout, domainSchema, salesContractTranslationService);
			platformUIStandardExtentService.extend(service, salesContractHeaderTextLayout.addition, domainSchema);
