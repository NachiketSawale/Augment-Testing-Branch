...
(function () {
	...
	/**
	 * @ngdoc service
	 * @name salesContractHeaderTextDataService
	 * @function
	 *
	 * @description
	 * salesContractHeaderTextDataService is Data Service for Header Plain Text Container
	 */
	salesContractModule.factory('salesContractHeaderTextDataService',
		['globals', '_', '$injector', '$q', '$http', 'platformModalService', 'salesContractService', 'platformDataServiceFactory', 'SalesCommonHeaderTextProcessor', 'salesCommonBlobsHelperService', 'basicsLookupdataLookupDescriptorService', 'basicsCommonTextFormatConstant', 'PlatformMessenger',
			'salesCommonDataHelperService',
			function (globals, _, $injector, $q, $http, platformModalService, salesContractService, platformDataServiceFactory, SalesCommonHeaderTextProcessor, salesCommonBlobsHelperService, basicsLookupdataLookupDescriptorService, basicsCommonTextFormatConstant, PlatformMessenger,
					  salesCommonDataHelperService) {
