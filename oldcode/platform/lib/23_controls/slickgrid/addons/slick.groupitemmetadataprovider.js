(function ($) {
	...
	function GroupItemMetadataProvider(options) {
		...
		function sumCellFormatter(value, decimalPlaces = 2) {
			let cultureInfo = options.language.getLanguageInfo(options.context.culture());
			return options.accounting.formatNumber(value, decimalPlaces, cultureInfo.numeric.thousand, cultureInfo.numeric.decimal);
		}
		...
		return {
			...
			'sumCellFormatter': sumCellFormatter
		};
	}
})(jQuery);
