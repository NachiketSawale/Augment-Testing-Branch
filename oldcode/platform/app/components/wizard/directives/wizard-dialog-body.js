...
(function (angular) {
	 ...
	 */
	angular.module('platform').directive('platformWizardDialogBody',
	...
	function platformWizardDialogBody($compile, $timeout, WizardHandler,
		...
		return {
			...
			link: function ($scope, elem) {
				...
				elem.append($compile('<wizard on-finish="$close(true)" on-wizard-ready="delayedProcessNewWizardStep()" template="' + globals.appBaseUrl + 'app/components/wizard/partials/wizard-template.html" name="' + $scope.wizardName + '" data-wz-data="wizard">' +
					'<div class="stepContainer">' +
					'<wz-step data-ng-repeat="step in wizard.steps" data-wz-title="{{step.title}}" data-canenter="canEnterWizardStep" data-step-definition="step" class="{{getCssClass(step)}}">' +
					...
					'<div data-ng-if="step.form && !step.loadingMessage" class="step-form">' +
