...
(function (angular) {
	...
	ControlTowerModul.controller('boqMainPowerbiViewController', SchedulingMainPowerbiViewController);
	...
	function SchedulingMainPowerbiViewController(
		...
		function loadReport() {
			var selectedItem = boqMainPowerBiDataService.getSelected();
		...
		boqMainPowerBiDataService.registerSelectionChanged(loadReport);
		...
		platformGridControllerService.initListController($scope, mtwoControlTowerUIStandardService, boqMainPowerBiDataService, mtwoControlTowerValidationService, myGridConfig);
		...
		$scope.$on('$destroy', function () {
			boqMainPowerBiDataService.unregisterSelectionChanged(loadReport);
