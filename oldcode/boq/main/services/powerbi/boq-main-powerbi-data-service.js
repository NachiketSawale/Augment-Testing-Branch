...
(function (angular) {
	...
	ControlTowerModul.factory('boqMainPowerBiDataService', BoqMainPowerBiDataService);
	BoqMainPowerBiDataService.$inject = ['mtwoControlTowerConfigurationMainService',
	...
	function BoqMainPowerBiDataService(mtwoControlTowerConfigurationMainService, platformDataServiceFactory,
		platformDataServiceProcessDatesBySchemeExtension, ServiceDataProcessArraysExtension,
		mtwoControlTowerConfigurationImageProcessor, boqMainService) {
		...
		boqMainService.registerListLoaded(function () {
			serviceContainer.service.load();
		});
