...
(function (angular) {
	...
	var configurationModule = 'mtwo.controltowerconfiguration';
	 ...
	 */
	ControlTowerModul.factory('mtwoControlTowerTranslationService', ['platformTranslationUtilitiesService', 'platformUIBaseTranslationService', 'mtwoControlTowerDataPineDashboardsLayout',
		function (platformTranslationUtilitiesService, platformUIBaseTranslationService, mtwoControlTowerDataPineDashboardsLayout) {
			var service = {};
			var data = {
				toTranslate: {},
				translate: null,
				updateCallback: null,
				allUsedModules: [moduleName, cloudCommonModule, configurationModule]
			};
			...
			data.words = {
				...
				AzureadIntegrated: {
					location: configurationModule,
					identifier: 'azureadIntegrated',
					initial: 'Azure AD Integrated'
				},
				BasCompanyFk: {location: cloudCommonModule, identifier: 'entityCompany', initial: 'Company'},
				ExternalName: {location: moduleName, identifier: 'ExternalName', initial: 'External Name'},
				DashboardTypeId: {location: moduleName, identifier: 'entityDashboardTypeId', initial: 'Dashboard Type'}
			};
			...
			var localBuffer = {};
			platformUIBaseTranslationService.call(this, new Array(mtwoControlTowerDataPineDashboardsLayout), localBuffer);
