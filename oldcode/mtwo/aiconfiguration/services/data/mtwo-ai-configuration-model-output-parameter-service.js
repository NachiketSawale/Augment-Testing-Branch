...
(function (angular) {
	...
	angular.module(moduleName).factory('mtwoAIConfigurationModelOutputParameterService', MtwoAIConfigurationModelOutputParameterService);

	MtwoAIConfigurationModelOutputParameterService.$inject = ['globals', 'platformDataServiceFactory', 'mtwoAIConfigurationModelVersionService', 'mtwoAIConfigurationConstantValues',
		'PlatformMessenger', 'cloudCommonGridService'];

	function MtwoAIConfigurationModelOutputParameterService(globals, platformDataServiceFactory, parentService, mtwoAIConfigurationConstantValues,
		PlatformMessenger, cloudCommonGridService) {
			...
			hierarchicalLeafItem: {
				...
				httpCRUD: {
					...
					initReadData: function initReadData(readData) {
						...
						readData.ParameterType = mtwoAIConfigurationConstantValues.parameterType.output;
						return readData;
					}
				},
