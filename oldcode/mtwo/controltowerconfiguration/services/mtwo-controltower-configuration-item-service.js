...
(function (angular) {
	...
	ControlTowerModul.factory('mtwoControlTowerConfigurationItemService', MtwoControlTowerConfigurationItemService);
	MtwoControlTowerConfigurationItemService.$inject = ['mtwoControlTowerConfigurationMainService', 'platformDataServiceFactory', 'platformDataServiceProcessDatesBySchemeExtension', 'ServiceDataProcessArraysExtension', 'mtwoControlTowerConfigurationImageProcessor'];

	function MtwoControlTowerConfigurationItemService(mtwoControlTowerConfigurationMainService, platformDataServiceFactory, platformDataServiceProcessDatesBySchemeExtension, ServiceDataProcessArraysExtension, mtwoControlTowerConfigurationImageProcessor) {

		var itemServiceOption = {
			hierarchicalNodeItem: {
				module: ControlTowerModul,
				httpRead: {route: globals.webApiBaseUrl + 'mtwo/controltower/powerbiitem/', endRead: 'list'},
				entityRole: {
					node:
						{
