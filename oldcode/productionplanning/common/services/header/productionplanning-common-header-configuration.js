(function (angular) {
	...
	//angular.module(moduleName).value('productionplanningCommonHeaderMainLayout', {});

	//master Layout
	angular.module(moduleName).factory('productionplanningCommonHeaderDetailLayout', ProductionplanningCommonHeaderLayout);
	ProductionplanningCommonHeaderLayout.$inject = ['basicsLookupdataConfigGenerator', 'platformLayoutHelperService', 'ppsCommonCustomColumnsServiceFactory', 'productionplanningCommonLayoutHelperService'];
	function ProductionplanningCommonHeaderLayout(basicsLookupdataConfigGenerator, platformLayoutHelperService, customColumnsServiceFactory, ppsCommonLayoutHelperService) {

		var config = {
			'fid': 'productionplanning.common.headerlayout',
			'version': '1.0.0',
			'showGrouping': true,
			...
			'groups': [
				{
					gid: 'header',
					attributes: ['headerstatusfk', 'code', 'descriptioninfo', 'basclerkprpfk', 'prjprojectfk', 'engheaderfk', 'lgmjobfk', 'estheaderfk', 'ordheaderfk',
						'mdlmodelfk', 'headergroupfk', 'islive', 'engdrawingfk']
				},
				{
					gid: 'production',
