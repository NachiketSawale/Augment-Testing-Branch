/**
 * Created bylas on 2/28/2025.
 */

(function (angular) {
	'use strict';

	angular.module('productionplanning.common').factory('productionplanningCommonCreateDialogConfigService', [
		...
		function (
			...
			self.showCreateDialog = function showCreateDialog() {
				...
				const dialogSettings = {
					...
					bodyTemplateUrl: globals.appBaseUrl + 'productionplanning.common/partials/create-dialog-template.html',
					backdrop: false,
