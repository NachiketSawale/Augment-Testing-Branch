...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name productionplanningReportTimeSheetLayoutServiceFactory
	 * @description
	 */
	angular.module(moduleName).service('productionplanningReportTimeSheetLayoutServiceFactory', TimeSheetLayoutServiceFactory);

	TimeSheetLayoutServiceFactory.$inject = ['_', '$injector', 'productionplanningReportTimeSheetDataServiceFactory',
		'productionplanningReportTimeSheetValidationFactory'];

	function TimeSheetLayoutServiceFactory(_, $injector, timeSheetDataServiceFactory,
		...
		this.createConfig = function createConfig(templUid, templInfo, parentService, dialogConfig) {
			...
			conf.dataServiceName = timeSheetDataServiceFactory.getService(templInfo, parentService, dialogConfig);
			conf.validationServiceName = timeSheetValidationFactory.createValidationService(conf.dataServiceName);
			return conf;
		};
