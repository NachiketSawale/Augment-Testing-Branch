(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name ppsMountingPlanningBoardRequisitionClipboardService
	 * @description provides cut, copy and paste functionality for the treeview grid
	 */
	/* jshint -W072 */ // many parameters because of dependency injection
	angular.module('productionplanning.mounting').service('ppsMountingPlanningBoardRequisitionClipboardService', PpsMountingPlanningBoardRequisitionClipboardService);

    PpsMountingPlanningBoardRequisitionClipboardService.$inject = ['globals', 'resourceReservationDataService', '$http', 'platformDragdropService'];

	function PpsMountingPlanningBoardRequisitionClipboardService(globals, resourceReservationDataService, $http, platformDragdropService) {
