(function(angular){
	...
	angular.module(moduleName).factory('ppsFormulaVersionValidationService', ValidationService);

	ValidationService.$inject = ['platformDataValidationService', 'ppsFormulaVersionDataService'];
