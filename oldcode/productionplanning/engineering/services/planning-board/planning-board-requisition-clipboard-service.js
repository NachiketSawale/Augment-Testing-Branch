...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name planningBoardRequisitionClipboardService
	 * @description provides cut, copy and paste functionality for the treeview grid
	 */
	/* jshint -W072 */ // many parameters because of dependency injection
	angular.module(moduleName).service('productionplanningEngineeringPlanningBoardRequisitionClipboardService', PlanningBoardRequisitionClipboardService);

	PlanningBoardRequisitionClipboardService.$inject = ['globals', 'resourceReservationDataService', '$http', 'platformDragdropService'];

	function PlanningBoardRequisitionClipboardService(globals, resourceReservationDataService, $http, platformDragdropService) {
