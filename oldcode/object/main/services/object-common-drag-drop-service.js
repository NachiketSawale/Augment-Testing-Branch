...
(function (angular) {
	...
	angular.module(moduleName).factory('objectCommonDragDropService', objectCommonDragDropService);

	objectCommonDragDropService.$inject = ['$injector'];

	function objectCommonDragDropService($injector) {
		let service = {};
