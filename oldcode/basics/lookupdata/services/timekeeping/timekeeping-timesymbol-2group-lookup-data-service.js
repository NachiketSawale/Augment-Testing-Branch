...
(function () {
	...
	/**
	 * @ngdoc service
	 * @name timekeepingTimeSymbol2GroupLookupDataService
	 * @function
	 *
	 * @description
	...
	angular.module('basics.lookupdata').factory('timekeepingTimeSymbol2GroupLookupDataService',
		['platformLookupDataServiceFactory', 'basicsLookupdataConfigGenerator',
			...
			function (
				...
				basicsLookupdataConfigGenerator.storeDataServiceDefaultSpec(
					'timekeepingTimeSymbol2GroupLookupDataService',
					{
						valMember: 'Id',
						dispMember: 'Code',
						columns: [
				...
				let locationLookupDataServiceConfig = {
					...
					prepareFilter: function prepareFilter(entity) {
						readData = {PKey1: null, PKey2: null, Pkey3: null , ByTimeAllocation : false};
						if (entity) {
