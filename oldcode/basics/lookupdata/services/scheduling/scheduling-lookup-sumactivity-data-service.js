/**
 * Created by Simon on 09.03.2021.
 */
(function (angular) {
	'use strict';
	...
	/**
	 * @ngdoc service
	 * @name schedulingLookupSumActivityDataService
	 * @function
	 *
	 * @description
	 * schedulingLookupSumActivityDataService is the data service for activity look ups
	 */
	angular.module('basics.lookupdata').factory('schedulingLookupSumActivityDataService', ['$injector', 'platformLookupDataServiceFactory', 'ServiceDataProcessArraysExtension', 'basicsLookupdataConfigGenerator', 'basicsLookupdataLookupFilterService', 'schedulingMainActivityImageProcessor',

		function ($injector, platformLookupDataServiceFactory, ServiceDataProcessArraysExtension, basicsLookupdataConfigGenerator, filterService, schedulingMainActivityImageProcessor) {

			basicsLookupdataConfigGenerator.storeDataServiceDefaultSpec('schedulingLookupSumActivityDataService', {
				valMember: 'Id',
				dispMember: 'Code',
				columns: [
					{
			...
			var filters = [
				...
				{
					key: 'self-reference-activity-exclude-activity',
					fn: function (activityItem, relationShip) {
						return activityItem.Id !== relationShip.ParentActivityFk && activityItem.ActivityTypeFk === 2;
					}
				}
			];
