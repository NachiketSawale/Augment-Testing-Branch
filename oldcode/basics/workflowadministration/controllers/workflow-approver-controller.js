...
(function () {
	...
	function basicsWorkflowAdministrationApproverController($scope, basicsWorkflowBaseGridController,
	                                                              platformTranslateService, basicsWorkflowAdministrationInstanceService,
	                                                              basicsWorkflowInstanceService, platformGridAPI, basicsWorkflowEntityApproversCommonColumns) {
		...
		function selectedListener(newVal) {
			if (newVal && newVal.Id) {
				basicsWorkflowAdministrationInstanceService.getApproversForInstance(newVal.Id).then(function (response) {

					basicsWorkflowBaseGridController.state.approvers = response.data;
					basicsWorkflowBaseGridController.state.selectedApprover = null;
				});
			}
		}

		//var columns = getColumns();
		var columns = basicsWorkflowEntityApproversCommonColumns.getStandardConfigForListView().columns;
	...
	basicsWorkflowAdministrationApproverController.$inject = ['$scope',
		'basicsWorkflowBaseGridController', 'platformTranslateService', 'basicsWorkflowAdministrationInstanceService',
		'basicsWorkflowInstanceService', 'platformGridAPI', 'basicsWorkflowEntityApproversCommonColumns'];
	angular.module(module).controller('basicsWorkflowAdministrationApproverController',
		basicsWorkflowAdministrationApproverController);
})();