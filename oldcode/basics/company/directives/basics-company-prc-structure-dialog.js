(function (angular, globals) {
	...
	globals.lookups.basCompanyPrcStructure = function prcStructure() {
		return {
			lookupOptions: {
				version: 3,
				...
				columns: [
					...
					{id: 'Comment', field: 'CommentTextInfo.Description', name: 'Comment', width: 300, formatter: 'description', name$tr$: 'cloud.common.entityCommentText'}
				],
				width: 660,
				height: 200,
				treeOptions: {
				...
				matchDisplayMembers: ['Code', 'DescriptionInfo.Description'],
	...
	angular.module(moduleName).directive('basicsCompanyPrcStructureDialog', [
		'BasicsLookupdataLookupDirectiveDefinition', '$translate', '$http',
		function (BasicsLookupdataLookupDirectiveDefinition, $translate, $http) {

			return new BasicsLookupdataLookupDirectiveDefinition('dialog-edit', globals.lookups.basCompanyPrcStructure().lookupOptions, {
