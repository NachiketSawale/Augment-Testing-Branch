...
(function (angular) {
	 ...
	 *
	 */
	angular.module(moduleName).service('basicsCommonDynamicStandardConfigMergeViewService', [
		'_', 'platformGridAPI', 'mainViewService',
		function (_, platformGridAPI, mainViewService) {
			let service = {};
