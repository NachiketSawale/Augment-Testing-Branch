(function (angular) {
	...
	angular.module('basics.common').controller('basicsCommonCreateDialogController',
		['$scope', 'basicsCommonCreateDialogConfigService', 'globals',
			...
			function ($scope, dialogConfigService, globals) {
				...
				okButton.disabled = function () {
					...
					let rootService = dialogConfigService.getRootService();
					if(!hasError && rootService && rootService.isOkDisable){
						hasError = rootService.isOkDisable();
					}
					return hasError;
				};
