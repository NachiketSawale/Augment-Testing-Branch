(function (angular) {
	...
	angular.module(moduleName).directive('basicsMaterialMaterialLookup', ['BasicsLookupdataLookupDirectiveDefinition', 'basicsMaterialLookupService', '$templateCache', '$injector',
		function (BasicsLookupdataLookupDirectiveDefinition, basicsMaterialLookupService, $templateCache, $injector) {
			var defaults = {
				...
				dialogOptions: {
					...
					templateUrl: globals.appBaseUrl + moduleName + '/templates/material-lookup/material-lookup-dialog.html',
