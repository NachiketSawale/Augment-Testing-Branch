...
(function (angular) {
	...
	angular.module(moduleName).directive('basicsMaterialCatalogGroupSuggestedPrcstructureLookup', ['_', '$q', '$http', 'globals', '$translate', '$timeout',
		'platformModalService', 'platformGridAPI', 'platformTranslateService', 'platformRuntimeDataService',
		'BasicsLookupdataLookupDirectiveDefinition', 'platformObjectHelper', 'materialCatalogGroupAiMappingService',
		...
		function (_, $q, $http, globals, $translate, $timeout,
		          ...
		          basicsMaterialCatalogGroupSuggestedPrcStructureDataService) {
			var defaults = {
				lookupType: 'suggestedPrcstructure',
				valueMember: 'Id',
				displayMember: 'Code',
				uuid: '5e7acb9a7cb042a3a621882570b1b9f2',
				columns: [
			...
			return new BasicsLookupdataLookupDirectiveDefinition('lookup-edit', defaults, {
				dataProvider: 'basicsMaterialCatalogGroupSuggestedPrcStructureDataService',
				...
				controller: ['$scope', function ($scope) {
					...
					function onOpenPopupClicked() {
						...
						var showOptions = {
							...
							width: '790px',
							height: '550px',
							templateUrl: globals.appBaseUrl + '/basics.materialcatalog/templates/procurement-structure-selection-dialog.html',
							backdrop: false,
							resizeable: true,
						...
						return platformModalService.showDialog(showOptions).then(function (result) {
							...
							$scope.$parent.entity.PrcStructureFk = result.data.Id;
							var prcStructure = {
								Id: result.data.Id,
							...
							basicsMaterialCatalogGroupSuggestedPrcStructureDataService.attachExtraData(prcStructure);
							materialCatalogGroupAiMappingService.gridRefresh();
						});
					}
