( function (angular) {
	...
	angular.module('basics.masterdata').directive('basicsMasterDataContextTaxCodeLookup', ['BasicsLookupdataLookupDirectiveDefinition','ServiceDataProcessDatesExtension',
