...
(function (angular) {
	...
	function basicsWorkflowReportActionParamsContainer(basicsWorkflowActionEditorService, platformGridAPI,
		...
		return {
			...
			require: 'ngModel',
			scope: true,
			templateUrl: globals.appBaseUrl + 'basics.workflow/templates/action-editors/report-action-params.html',
			compile: function () {
				return {
	...
	basicsWorkflowReportActionParamsContainer.$inject = ['basicsWorkflowActionEditorService', 'platformGridAPI',
	...
	angular.module('basics.workflow')
		.directive('basicsWorkflowReportActionParamsContainer', basicsWorkflowReportActionParamsContainer);
