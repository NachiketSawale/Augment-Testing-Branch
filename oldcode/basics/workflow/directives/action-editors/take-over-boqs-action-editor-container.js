...
(function (angular) {
	...
	function basicsWorkflowTakeOverBoQsActionEditorContainer(_, basicsWorkflowActionEditorService) {
		return {
			restrict: 'A',
			require: 'ngModel',
			templateUrl: globals.appBaseUrl + 'basics.workflow/templates/action-editors/take-over-boqs-action-editor.html',
			compile: function () {
				return {
	...
	basicsWorkflowTakeOverBoQsActionEditorContainer.$inject = ['_', 'basicsWorkflowActionEditorService'];

	let moduleName = 'basics.workflow';
	angular.module(moduleName).directive('basicsWorkflowTakeOverBoQsActionEditorContainer', basicsWorkflowTakeOverBoQsActionEditorContainer)
		.config(['basicsWorkflowModuleOptions', function (basicsWorkflowModuleOptions) {
			basicsWorkflowModuleOptions.actionEditors.push(
				{
					actionId: '0456E92770564C849F21CB5928F60947',
					directive: 'basicsWorkflowTakeOverBoQsActionEditorContainer',
					prio: null,
					tools: []
				}
			);
