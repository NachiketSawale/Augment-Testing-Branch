/**
 * Created by  baitule on 02.09.2019.
 */
...
(function (angular) {
	...
	function basicsWorkflowSqlToCsvActionEditorDirective(basicsWorkflowActionEditorService, platformCreateUuid, platformGridAPI,
		_, basicsWorkflowEditModes, $timeout, $translate, basicsWorkflowGlobalContextUtil) {
		return {
			restrict: 'A',
			require: 'ngModel',
			templateUrl: globals.appBaseUrl + 'basics.workflow/templates/action-editors/sql-to-csv-action-editor.html',
			compile: function () {
				return {
					pre: function (scope, iElement, attr, ngModelCtrl) {
						...
						ngModelCtrl.$render = function () {
							...
							scope.fieldSeparator = _.find(scope.action.input, {key: 'FieldSeparator'});
							scope.fileName = _.find(scope.action.input, {key: 'FileName'});
							scope.output = _.find(scope.action.output, {key: 'DocId'});
						};
	...
	basicsWorkflowSqlToCsvActionEditorDirective.$inject = ['basicsWorkflowActionEditorService', 'platformCreateUuid',
		'platformGridAPI', '_', 'basicsWorkflowEditModes', '$timeout', '$translate', 'basicsWorkflowGlobalContextUtil'];

	angular.module('basics.workflow')
		.directive('basicsWorkflowSqlToCsvActionEditorDirective', basicsWorkflowSqlToCsvActionEditorDirective)
		.config(['basicsWorkflowModuleOptions', function (basicsWorkflowModuleOptions) {
			basicsWorkflowModuleOptions.actionEditors.push(
				{
					actionId: '8cd6fa38085740d08131015776f47839',
					directive: 'basicsWorkflowSqlToCsvActionEditorDirective',
					prio: null,
					tools: []
				}
			);
