(function (angular) {
	...
	angular.module(moduleName).factory('basicsworkflowApproveSimpleFilterService', [
		...
		function ($http, $q, $translate, cloudDesktopEnhancedFilterService, basicsCommonConfigLocationListService,
			...
			function createService(parentServiceName) {
				...
				service.loadAllFilters = function loadFilterDefinitions() {
					return $http.get(globals.webApiBaseUrl + 'basicsworkflow/master/selectionstatement/getfilterdefinitions?type=simple').then(function (response) {
						var filterDtos = [];
				...
				service.deleteFilterDefinition = function deleteFilterDefinition(filterDto) {
					return $http.post(
						globals.webApiBaseUrl + 'basicsworkflow/master/selectionstatement/deletefilterdefinition',
						filterDto
					).then(function () {
				...
				service.saveFilterDefinition = function saveFilterDefinition(filterDto) {
					...
					return $http.post(globals.webApiBaseUrl + 'basicsworkflow/master/selectionstatement/savefilterdefinition', filterDefParams).then(function () {
				...
				var filterPermissions = basicsCommonConfigLocationListService.checkAccessRights({
					u: '8c4d43ee6faa4542bb117e7787a875e7',
					r: '686de7ff9fd24a2187e5914c2fde3e99',
					g: '2972b0d67d9e4676906e83d0b0cdbd75',
