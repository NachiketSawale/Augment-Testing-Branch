...
(function (angular) {
	...
	angular.module('basics.billingschema').factory('basicsBillingSchemaRubricCategoryStandardConfigurationService', ['platformUIStandardConfigService', 'basicsBillingschemaTranslationService', 'basicsBillingSchemaConfigurationValuesService', 'platformSchemaService',
		function (platformUIStandardConfigService, basicsBillingschemaTranslationService, basicsBillingSchemaConfigurationValuesService, platformSchemaService) {
			...
			var attributeDomains = platformSchemaService.getSchemaFromCache({
				typeName: 'RubricCategoryTreeItemDto',
			...
			return new BaseService(
				basicsBillingSchemaConfigurationValuesService.getBasicsBiillingSchemaRubricCategoryLayout(),
				attributeDomains,
