(function () {
	...
	angular.module(modName).factory('procurementStructureDocumentLayout',['documentsProjectDocumentDataService','documentsProjectDocumentModuleContext',
		function (documentsProjectDocumentDataService, documentsProjectDocumentModuleContext) {
			return {
				'fid': 'procurement.structure.detail',
				'version': '1.0.0',
	...
	angular.module(modName).factory('procurementStructureDocumentUIStandardService',
		['platformUIStandardConfigService', 'procurementCommonTranslationService',
			'procurementStructureDocumentLayout', 'platformSchemaService', 'platformUIStandardExtentService',
