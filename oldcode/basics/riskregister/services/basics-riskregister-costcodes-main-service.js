...
(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name basicsRiskRegisterCostCodesMainService
	 * @function
	 *
	 * @description
	 * basicsRiskRegisterCostCodesMainService is the data service for all costcodes related functionality.
	 */
	/* jshint -W072 */ // many parameters because of dependency injection
	riskRegisterModule.factory('basicsRiskRegisterCostCodesMainService', ['_', 'PlatformMessenger','platformDataServiceFactory', 'platformModalService', 'platformGridAPI', 'basicsCommonMandatoryProcessor',
		...
		function (_, PlatformMessenger,platformDataServiceFactory, platformModalService, platformGridAPI, basicsCommonMandatoryProcessor,
			...
			var basicsCostCodesMainServiceOptions = {
				hierarchicalRootItem: {
					...
					serviceName: 'basicsRiskRegisterCostCodesMainService',
