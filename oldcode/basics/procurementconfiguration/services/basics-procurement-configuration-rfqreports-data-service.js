...
(function (angular) {
	...
	// jshint -W072
	angular.module(moduleName).factory('basicsProcurementConfigurationRfqReportsService',
		['$q','$injector','platformDataServiceFactory', 'basicsProcurementConfigHeaderDataService', 'basicsProcurementConfigurationRubricCategoryService', 'basicsProcurementConfigurationDataService', 'basicsCommonMandatoryProcessor', 'basicsProcurementConfigurationRfqReportsValidationService',
			function ($q,$injector,dataServiceFactory, headerService, rubricCategoryService, parentService, mandatoryProcessor, commonValidationService) {
				var serviceOptions = {
					flatLeafItem: {
						serviceName: 'basicsProcurementConfigurationRfqReportsService',
						entityNameTranslationID: 'basics.procurementconfiguration.rfqReports',
						...
						httpCRUD: {
							...
							initReadData: function initReadData(readData) {
								...
								readData.filter = '?mainItemId=' + contextFk + '&reportType=2';
							}
						},
						presenter: {
							list: {
