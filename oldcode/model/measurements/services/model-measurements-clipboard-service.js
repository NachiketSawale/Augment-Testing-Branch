...
(function (angular) {
	...
	/* global angular,_ */
	var moduleName = 'model.measurements';

	angular.module(moduleName).factory('modelMeasurementsClipboardService', modelMeasurementsClipboardService);

	modelMeasurementsClipboardService.$inject = ['$injector'];

	function modelMeasurementsClipboardService($injector) {
		var service = {};
