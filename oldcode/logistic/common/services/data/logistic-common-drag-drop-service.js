...
(function (angular) {
	...
	angular.module(moduleName).factory('logisticCommonDragDropService', logisticCommonDragDropService);

	logisticCommonDragDropService.$inject = ['$injector'];

	function logisticCommonDragDropService($injector) {
		let service = {};
