...
(function (angular) {
	...
	// logisticJobPlantAllocationFilterItemGroupDataService
	angular.module(moduleName).service('logisticJobPlantAllocationFilterItemGroupDataService', LogisticJobPlantAllocationFilterItemGroupDataService);

	LogisticJobPlantAllocationFilterItemGroupDataService.$inject = ['_', 'logisticJobPlantAllocationFilterItemDataService'];

	function LogisticJobPlantAllocationFilterItemGroupDataService(_, logisticJobPlantAllocationFilterItemDataService) {
		let self = this;
		...
		this.createFilterItem = function createFilterItem() {
			let newFilterItem = logisticJobPlantAllocationFilterItemDataService.createFilterItem(1);
