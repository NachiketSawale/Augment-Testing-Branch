...
(function (angular) {
	...
	// logisticJobPlantAllocationFilterItemKindDataService
	angular.module(moduleName).service('logisticJobPlantAllocationFilterItemKindDataService', LogisticJobPlantAllocationFilterItemKindDataService);

	LogisticJobPlantAllocationFilterItemKindDataService.$inject = ['_', 'logisticJobPlantAllocationFilterItemDataService'];

	function LogisticJobPlantAllocationFilterItemKindDataService(_, logisticJobPlantAllocationFilterItemDataService) {
		let self = this;
		...
		this.createFilterItem = function createFilterItem() {
			let newFilterItem = logisticJobPlantAllocationFilterItemDataService.createFilterItem(3);
