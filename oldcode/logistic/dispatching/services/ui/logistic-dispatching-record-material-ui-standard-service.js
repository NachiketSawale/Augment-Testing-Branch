...
(function (angular) {
	...
	/**
	 * @ngdoc controller
	 * @name logisticDispatchingRecordMaterialUIConfigurationService
	 * @function
	 *
	 * @description
	 * This service provides standard layout for grid / form of  logistic dispatching ui entity.
	 **/
	angular.module(moduleName).service('logisticDispatchingRecordMaterialUIConfigurationService', LogisticDispatchingRecordUIConfigurationService);
	...
	function LogisticDispatchingRecordUIConfigurationService(platformUIConfigInitService, logisticDispatchingContainerInformationService, logisticDispatchingTranslationService) {
		platformUIConfigInitService.createUIConfigurationService({
			service: this,
			layout: logisticDispatchingContainerInformationService.getLogisticDispatchingRecordByMaterialLayout(),
			dtoSchemeId: {
