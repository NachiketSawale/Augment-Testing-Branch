...
(function (angular) {
	...
	/**
	 * @ngdoc controller
	 * @name logisticSettlementDispatchRecordForTypeDetailController
	 * @function
	 *
	 * @description
	 * Controller for the detail view of logistic dispatching record for type entities.
	 **/
	angular.module(moduleName).controller('logisticSettlementDispatchRecordArticleDetailController', LogisticSettlementDispatchArticleDetailController);

	LogisticSettlementDispatchArticleDetailController.$inject = ['$scope', 'platformRecordArticleDetailControllerService', 'logisticSettlementDispatchRecordArticleDataService', 'logisticDispatchingConstantValues', '$injector', 'logisticDispatchingTranslationService',
		'logisticSettlementDispatchRecordDataService', 'platformDataServiceProcessDatesBySchemeExtension'];

	function LogisticSettlementDispatchArticleDetailController($scope, platformRecordArticleDetailControllerService, logisticSettlementDispatchRecordArticleDataService, logisticDispatchingConstantValues, $injector, logisticDispatchingTranslationService,
		...
		platformRecordArticleDetailControllerService.initController($scope, 'RecordTypeFk', 'ArticleFk', configDefinitions,
				logisticDispatchingConstantValues.record.type.resource, logisticSettlementDispatchRecordArticleDataService, logisticDispatchingRecordDataService, logisticDispatchingTranslationService);
	}
})(angular);