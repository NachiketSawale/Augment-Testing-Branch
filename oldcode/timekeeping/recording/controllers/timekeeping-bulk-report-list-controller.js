...
(function (angular) {
	...
	angular.module('timekeeping.recording').controller('timekeepingBulkReportListController', ['$scope', '_', '$translate', '$http', 'platformGridAPI','timeKeepingRecordingSideBarWizardService',
		function ($scope, _, $translate, $http, platformGridAPI,timeKeepingRecordingSideBarWizardService) {
			$scope.gridId = '33bcca8e156b4afd98f63cf089a464e9';
			$scope.gridData = { state: $scope.gridId };
			$scope.reports = timeKeepingRecordingSideBarWizardService.getReports();
