(function (angular) {
	...
	/**
	 * @ngdoc service
	 * @name timekeepingRoundingConfigDetailDataService
	 * @function
	 *
	 * @description
	 * This service provides Timekeeping Rounding Detail Data Service for dialog.
	 */
	angular.module(moduleName).factory('timekeepingRoundingConfigDetailDataService',
		['$q', '$http', '$translate', 'PlatformMessenger', 'platformDataServiceFactory', 'timekeepingRoundingConfigDetailProcessService',
			function ($q, $http, $translate, PlatformMessenger, platformDataServiceFactory, timekeepingRoundingConfigDetailProcessService) {
				...
				function setDataList(items) {
					if (Array.isArray(items)) {
						timekeepingRoundingConfigDetailProcessService.processItems(items);
						data = items;
					} else {
						data = [];
					}
...
*/
				...
				function getItemsToSave(){
					return itemsToSave ? itemsToSave : null;
				}
