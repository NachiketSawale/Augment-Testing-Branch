...
angular.module('scheduling.main').factory('schedulingMainPapersizeLookupService', ['$q', '$injector', 'platformSchemaService', 'platformLookupDataServiceFactory',
	function ($q, $injector, schemaservice, servicefactory) {
		'use strict';
		var readData =  { PKey1: null };

		var service = servicefactory.createInstance({
			httpRead: { route: globals.webApiBaseUrl + 'basics/customize/papersize/', endPointRead: 'list', usePostForRead: true },
