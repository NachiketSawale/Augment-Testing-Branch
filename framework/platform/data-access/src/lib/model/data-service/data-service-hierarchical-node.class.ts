 ...
 */
export class DataServiceHierarchicalNode<T extends object, U extends CompleteIdentification<T>,
	...
	public constructor(options: IDataServiceOptions<T>) {
		...
		this.nodeRole = new NodeRole<T, U, PT, PU>(this.entityTree, this.provider, this.processor,
		...
		this.entitySelection = new ParentEntitySelection<T, U>(this.nodeRole, this.entityTree, this.converter);
	...
	public remove(entities: T[] | T): void {
		this.entityTree.remove(entities);
	}
