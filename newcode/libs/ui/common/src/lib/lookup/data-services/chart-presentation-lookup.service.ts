...
export class UiCommonChartPresentationLookupService<TEntity extends object = object> extends UiCommonLookupSimpleDataService<LookupSimpleEntity, TEntity> {
    public constructor() {
        super('basics.customize.chartpresentation', {
            uuid: '',
            valueMember: 'id',
