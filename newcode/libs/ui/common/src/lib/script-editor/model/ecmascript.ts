...
/**
 * copy from https://github.com/ternjs/tern/blob/master/defs/ecmascript.json
 */
export const ecmascript = {
	...
	'String': {
		...
		'prototype': {
			...
			'contains': {
				'!type': 'fn(searchString: string) -> bool',
				'!doc': 'The contains() method determines whether one string may be found within another string, returning true or false as appropriate.',
