...
import { getInputBoolean, getInputPositiveNumber } from '../model/utils';
...
/**
 * Class implements areas which are required by splitter
 */
export class SplitAreaDirective implements OnInit, OnDestroy {
	...
	private _sizeBeforeCollapse: number | null = null;

	@Input() set sizeBeforeCollapse(v: number | null) {
		this._sizeBeforeCollapse = v;
	}

	get sizeBeforeCollapse() {
		return this._sizeBeforeCollapse;
	}
	...
	constructor(private ngZone: NgZone, public elRef: ElementRef, private renderer: Renderer2, private split: SplitComponent) {
