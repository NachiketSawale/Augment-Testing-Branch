...
import { SchedulingMainRequisitionDataService } from '../services/scheduling-main-requisition-data.service';

//TODO use the resource requisition entity info model?

export const SCHEDULING_MAIN_REQUISITION_ENTITY_INFO: EntityInfo = EntityInfo.create<IRequisitionEntity>({
	grid: {
	...
	dataService: ctx => ctx.injector.get(SchedulingMainRequisitionDataService),
	//TODO validationService: (ctx) => ctx.injector.get(ResourceRequisitionValidationService),
