...
import { SalesContractRelatedBillBehavior } from '../../behaviors/sales-contract-related-bill-behavior.service';
import { SalesContractRelatedBillDataService } from '../../services/sales-contract-related-bill-data.service';

export const SALES_CONTRACT_RELATED_BILL_ENTITY_INFO: EntityInfo = EntityInfo.create<IBillHeaderEntity> ({
	grid: {
		title: {key: 'sales.contract.relatedBills'},
		behavior: ctx => ctx.injector.get(SalesContractRelatedBillBehavior),
	},
	dataService: ctx => ctx.injector.get(SalesContractRelatedBillDataService),
	dtoSchemeId: {moduleSubModule: 'Sales.Billing', typeName: 'BilHeaderDto'},
	permissionUuid: 'd9e8ac9295a148a0910a185c71d87661',
	layoutConfiguration: {
		groups: [
