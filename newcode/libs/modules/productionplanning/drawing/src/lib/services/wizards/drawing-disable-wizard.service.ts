...
export class DrawingDisableWizardService extends BasicsSharedSimpleActionWizardService<IEngDrawingEntity> {
	...
	public onStartDisableWizard(): void {
		const option: ISimpleActionOptions<IEngDrawingEntity> = {
			headerText: 'productionplanning.drawing.wizard.disableDrawingCaption',
			codeField: 'Code',
			doneMsg: 'productionplanning.drawing.wizard.enableDisableDrawingDone',
			nothingToDoMsg: 'productionplanning.drawing.wizard.drawingAlreadyDisabled',
