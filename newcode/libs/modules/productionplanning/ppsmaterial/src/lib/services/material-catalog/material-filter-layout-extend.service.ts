// remark: current file is copied from basics-material-material-filter-layout-extend.service in basics.material, 
...
export class PpsMaterialFilterLayoutExtendHelper<T extends object> {
