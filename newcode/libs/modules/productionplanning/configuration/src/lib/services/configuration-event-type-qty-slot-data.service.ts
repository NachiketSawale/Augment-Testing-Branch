...
export class ConfigurationEventTypeQtySlotDataService extends DataServiceFlatRoot<IEventTypeSlotEntity, EventTypeSlotComplete> {
	public constructor() {
		const options: IDataServiceOptions<IEventTypeSlotEntity> = {
			...
			readInfo: <IDataServiceEndPointOptions>{
				endPoint: 'filtered',
				usePost: true,
				//TODO: prepareParam: ident => ({FurtherFilters: [{Token: 'ColumnSelection', Value: 'quantity'}]})
			},
