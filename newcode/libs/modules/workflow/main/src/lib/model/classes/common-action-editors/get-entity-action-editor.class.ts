 ...
 */
export class GetEntityActionEditor extends ActionEditorBase {
	...
	public constructor(workflowAction: IWorkflowAction, actionService: BasicsWorkflowActionDataService, injector: Injector) {
		...
		this.createField(FieldType.Comment, EntityActionsParamsEnum.EntityIdForGetEntityAction, ParameterType.Input, 'basics.workflow.action.customEditor.id', {} as ICodemirrorEditorOptions);
