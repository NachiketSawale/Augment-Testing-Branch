...
import { CopyAdjustPriceType } from './toolbar/estimate-main-copy-adjust-price.type';
import { PriceAdjustCopyTenderComponent } from '../../components/price-adjust-copy-tender/price-adjust-copy-tender.component';
import { CopyAdjustPriceResponse } from './toolbar/estimate-main-copy-adjust-price-response.type';
