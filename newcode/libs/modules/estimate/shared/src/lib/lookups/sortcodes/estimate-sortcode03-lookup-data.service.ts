...
/**
 * @name EstimateSortCode03LookupDataService
 * @description It is the data service for estimate sort code lookup*
 */
export class EstimateSortCode03LookupDataService<IEntity extends object> extends UiCommonLookupEndpointDataService<ISortcodes, IEntity> {
	public constructor(public sortcodeCommonService:EstimateSortCodeCommonLookupDataService) {
		super(
			sortcodeCommonService.createDataService('sortcode03'),
			{
				uuid: '4f7a36d42e2f4817b95dfc202571533e',
				idProperty: 'Id',
				valueMember: '',
				displayMember: '',
				gridConfig: {
