...
/**
 * @name EstimateSortCode09LookupDataService
 * @description It is the data service for estimate sort code lookup*
 */
export class EstimateSortCode09LookupDataService<IEntity extends object> extends UiCommonLookupEndpointDataService<ISortcodes, IEntity> {
	public constructor(public sortcodeCommonService:EstimateSortCodeCommonLookupDataService) {
		super(
			sortcodeCommonService.createDataService('sortcode09'),
			{
				uuid: 'dd3cf347992244f9930596ba96524a19',
				idProperty: 'Id',
				valueMember: '',
				displayMember: '',
				gridConfig: {
