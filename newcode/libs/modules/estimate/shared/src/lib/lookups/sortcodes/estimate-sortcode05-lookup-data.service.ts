...
/**
 * @name EstimateSortCode05LookupDataService
 * @description It is the data service for estimate sort code lookup*
 */
export class EstimateSortCode05LookupDataService<IEntity extends object> extends UiCommonLookupEndpointDataService<ISortcodes, IEntity> {
	public constructor(public sortcodeCommonService:EstimateSortCodeCommonLookupDataService) {
		super(
			sortcodeCommonService.createDataService('sortcode05'),
			{
				uuid: 'a19b5d7e465a4b6381f6149efe072b9b',
				idProperty: 'Id',
				valueMember: '',
				displayMember: '',
				gridConfig: {
