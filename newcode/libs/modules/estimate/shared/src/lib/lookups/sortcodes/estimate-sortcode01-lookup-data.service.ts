...
/**
 * @name EstimateSortCode01LookupDataService
 * @description It is the data service for estimate sort code lookup*
 */
export class EstimateSortCode01LookupDataService<IEntity extends object> extends UiCommonLookupEndpointDataService<ISortcodes, IEntity> {
	public constructor(public sortcodeCommonService:EstimateSortCodeCommonLookupDataService) {
		super(
			sortcodeCommonService.createDataService('sortcode01'),
			{
				uuid: '95b2c3984c2b4d0c844f7b127c856b5d',
				idProperty: 'Id',
				valueMember: '',
				displayMember: '',
				gridConfig: {
