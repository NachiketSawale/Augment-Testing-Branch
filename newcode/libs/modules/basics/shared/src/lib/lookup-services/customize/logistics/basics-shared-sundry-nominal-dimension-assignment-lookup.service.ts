...
import { IBasicsCustomizeSundryNominalDimensionAssignmentEntity } from '@libs/basics/interfaces';

/**
 * Lookup Service for IBasicsCustomizeSundryNominalDimensionAssignmentEntity from customize module
 */
...
export class  BasicsSharedSundryNominalDimensionAssignmentLookupService<T extends object = object> extends UiCommonLookupEndpointDataService<IBasicsCustomizeSundryNominalDimensionAssignmentEntity, T>  {
	public constructor() {
		super({
			httpRead: { route: 'basics/customize/sundrynominaldimensionassignment/', endPointRead: 'list', usePostForRead: true }
		}, {
			uuid: '64b27066511e44e7b9164a4ae33b4a55',
			valueMember: 'Id',
