...
export class BasicsRegionTypeFormBehavior implements IEntityContainerBehavior<IGridContainerLink<BasicsRegionTypeEntity>, BasicsRegionTypeEntity> {
	...
	public onCreate(containerLink: IGridContainerLink<BasicsRegionTypeEntity>): void {
		...
		containerLink.uiAddOns.toolbar.deleteItems(["create", "delete", "grouping"]);
