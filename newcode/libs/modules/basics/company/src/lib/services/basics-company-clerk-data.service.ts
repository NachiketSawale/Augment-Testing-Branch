...
export class BasicsCompanyClerkDataService extends DataServiceFlatLeaf<ICompany2ClerkEntity,ICompanyEntity, BasicsCompanyComplete>{

	public constructor(basicsCompanyMainDataService: BasicsCompanyMainDataService) {
		const options: IDataServiceOptions<ICompany2ClerkEntity>  = {
			apiUrl: 'basics/company/clerk',
			...
			roleInfo: <IDataServiceChildRoleOptions<ICompany2ClerkEntity,ICompanyEntity, BasicsCompanyComplete>>{
	...
	public override isParentFn(parentKey: ICompanyEntity, entity: ICompany2ClerkEntity): boolean {
