...
export class BasicsMaterialMaterialCatalogDataService extends DataServiceFlatRoot<IMaterialCatalogEntity, BasicsMaterialMaterialCatalogComplete> {
	 ...
	 * @param modified
	 */
	public override createUpdateEntity(modified: IMaterialCatalogEntity | null): BasicsMaterialMaterialCatalogComplete {
		return new BasicsMaterialMaterialCatalogComplete(null);
	}
