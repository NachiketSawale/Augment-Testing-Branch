...
export class BasicsMaterialMaterialGroupDataService extends DataServiceHierarchicalLeaf<IMaterialGroupEntity, IMaterialCatalogEntity, BasicsMaterialMaterialCatalogComplete> {
	 ...
	 * The constructor
	 */
	public constructor(private catalogService: BasicsMaterialMaterialCatalogDataService) {
		const options: IDataServiceOptions<IMaterialGroupEntity> = {
			apiUrl: 'basics/materialcatalog/group',
			roleInfo: <IDataServiceChildRoleOptions<IMaterialGroupEntity, IMaterialCatalogEntity, BasicsMaterialMaterialCatalogComplete>>{
	...
	private fireGroupCheckedChangedForMaterial() {
		const basicsMaterialRecordDataService = ServiceLocator.injector.get(BasicsMaterialRecordDataService);
		basicsMaterialRecordDataService.onGroupCheckChanged();
	}
