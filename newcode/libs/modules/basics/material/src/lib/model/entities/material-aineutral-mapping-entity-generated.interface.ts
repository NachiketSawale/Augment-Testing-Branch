...
export interface IMaterialAINeutralMappingEntityGenerated extends IEntityBase {
  ...
  /**
   * MatchedNeturalMaterialFks
   */
  MatchedNeturalMaterialFks?: number[] | null;
