...
import { BasicsSharedItemType2LookupService, BasicsSharedItemTypeLookupService, BasicsSharedPaymentTermLookupService, BasicsSharedUomLookupService } from '@libs/basics/shared';
import { ConcreteFieldOverload, createLookup, FieldType, FieldValidationInfo } from '@libs/ui/common';
...
import { ProcurementPricecomparisonSingleLineAreatextComponent } from '../../../components/data/single-line-areatext/single-line-areatext.component';
...
export class CompareBoqColumnBuilder extends CompareColumnBaseBuilder<ICompositeBoqEntity, ICompareBoqTreeResponse> {
	...
	private getBasicsColumns(): CompareGridColumn<ICompositeBoqEntity>[] {
		return [
			...
			// Common Columns
			super.createColumn('boqLineType', 'BoqLineType', {text: 'BoQ Line Type', key: 'boq.main.BoqLineTypeFk'}, FieldType.Description, 100, true),
			super.createColumn('reference', 'Reference', {text: 'Reference No.', key: 'boq.main.Reference'}, FieldType.Description, 105, true),
			super.createColumn('brief', 'Brief', {text: 'Outline Specification', key: 'cloud.common.entityBriefInfo'}, FieldType.Description, 130, true),
			super.createColumn('itemInfo', 'ItemInfo', {text: 'ItemInfo', key: 'boq.main.ItemInfo'}, FieldType.Description, 130, true),
			super.createColumn('aan', 'Aan', {text: 'AAN', key: 'boq.main.AAN'}, FieldType.Description, 80, true),
			super.createColumn('agn', 'Agn', {text: 'AGN', key: 'boq.main.AGN'}, FieldType.Description, 80, true),
			super.createColumn('budgetperunit', 'BudgetPerUnit', {text: 'Budget/Unit', key: 'boq.main.BudgetPerUnit'}, FieldType.Description, 80, true),
			super.createColumn('budgettotal', 'BudgetTotal', {text: 'Budget Total', key: 'boq.main.BudgetTotal'}, FieldType.Description, 80, true),
			super.createColumn('budgetdifference', 'BudgetDifference', {text: 'Budget Difference', key: 'boq.main.BudgetDifference'}, FieldType.Description, 80, true),
			super.createLookupColumn('BasItemTypeFk', 'BasItemTypeFk', {text: 'Item Type Stand/Opt', key: 'boq.main.BasItemTypeFk'}, 125, true, {
				dataServiceToken: BasicsSharedItemTypeLookupService
			}),
			super.createLookupColumn('BasItemType2Fk', 'BasItemType2Fk', {text: 'Item Type Base/Alt', key: 'boq.main.BasItemType2Fk'}, 125, true, {
			...
			super.createColumn('quantityAdjustment', 'QuantityAdjustment', {text: 'AQ-Quantity', key: 'boq.main.QuantityAdj'}, FieldType.Description, 85, true),
			super.createColumn('uomFk', 'UomFk', {text: 'UoM', key: 'cloud.common.entityUoM'}, FieldType.Description, 85, true, this.colFormatter.uom()),
			super.createColumn('isDisabled', 'IsDisabled', {text: 'Disabled', key: 'boq.main.IsDisabled'}, FieldType.Boolean, 75, true, this.colFormatter.isDisable()),
			super.createColumn('isNotApplicable', 'IsNotApplicable', {text: 'N/A', key: 'boq.main.IsNotApplicable'}, FieldType.Boolean, 95, true, this.colFormatter.isNotApplicable()),
			super.createColumn('isFreeQuantity', 'IsFreeQuantity', {text: 'Free Quantity', key: 'boq.main.IsFreeQuantity'}, FieldType.Boolean, 95, true, this.colFormatter.isFreeQuantity()),
			super.createColumn('isLeadDescription', 'IsLeadDescription', {text: 'Lead Description', key: 'boq.main.IsLeadDescription'}, FieldType.Boolean, 95, true, this.colFormatter.isLeadDescription()),
			super.createColumn('isNoLeadQuantity', 'IsNoLeadQuantity', {text: 'Lead Quantity', key: 'procurement.pricecomparison.leadQuantity'}, FieldType.Boolean, 95, true, this.colFormatter.isNoLeadQuantity()),
			super.createColumn('isContracted', 'IsContracted', {text: 'Contracted in other PKG', key: 'procurement.common.entityIsContractedInOtherPkg'}, FieldType.Boolean, 150, true, this.colFormatter.isContracted()),
	...
	public customQuoteColumnRowCellEditor(dataContext: ICompositeBoqEntity, quoteColumn: ICustomCompareColumnEntity, columnDef: CompareGridColumn<ICompositeBoqEntity>, columnDomainFn: unknown): Observable<ConcreteFieldOverload<ICompositeBoqEntity>> {
		...
		columnDef.validator = (info: FieldValidationInfo<ICompositeBoqEntity>) => {
		...
		if (compareFiled === CompareFields.prcItemEvaluationFk) {
			...
			return from<ConcreteFieldOverload<ICompositeBoqEntity>[]>([{
				...
				componentType: ProcurementPricecomparisonSingleLineAreatextComponent
			}]);
