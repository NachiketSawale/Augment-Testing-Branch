...
/**
 * Procurement Rfq Email Fax Boq Report Template lookup Service
 */
export class ProcurementRfqEmailFaxBoqReportTemplatelookupService<T extends object = object> extends UiCommonLookupEndpointDataService<IReportData, T> {
    public constructor() {
        super({
            httpRead: {
                route: 'basics/reporting/sidebar',
                endPointRead: 'load?module=boq.main',
