 ...
 */
//Todo: IQuoteHeaderEntity is already present in the Quote module. However, importing IQuoteHeaderEntity causes a circular dependency error. Therefore, I have temporarily created it in the Interface module.
