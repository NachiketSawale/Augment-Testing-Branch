...
import { IBpRelationType, IBusinessPartnerEntity, IBusinessPartnerInfo, IRelation, IRelationChartData, IRelationLoadedEntity, IRelationNode, ISubsidiaryEntity, NodeDataType } from '@libs/businesspartner/interfaces';
...
export class BusinesspartnerMainRelationChartDataService {
	...
	public async load(depth: number, dontUseCache: boolean, businessPartner:IBusinessPartnerEntity | null): Promise<IRelationChartData | null> {
