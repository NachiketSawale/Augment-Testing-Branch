...
import {
	DataServiceFlatLeaf, IDataServiceOptions,
	ServiceRole
...
export abstract class BusinesspartnerSharedCertificateLeafDataService<PT extends object, PU extends CompleteIdentification<PT>>
	extends DataServiceFlatLeaf<ICertificateEntity, PT, PU> {
