...
import { DataServiceFlatNode, EntityDateProcessorFactory, IDataServiceOptions, IEntityProcessor, IEntitySchemaId, IRootRole } from '@libs/platform/data-access';
...
import { DocumentDataNodeReadonlyProcessorService } from './processors/document-data-readonly-processor.service';
...
import { ICreateForUploadFileRequest, ICreateForUploadFileResponse } from './interface/create-for-upload-file-request.interace';

// remark: the codes of DocumentDataNodeService are almost copied from DocumentDataLeafService, because of technical reasons(like Typescript does not support inheriting multiple classes, so cannot extract common functionalities of DocumentDataLeafService and DocumentDataNodeService into another base service class)
/**
 * The document base node data service for difference document type entity
 * for example: the ppsDocument is the children of other entity
 */
export abstract class DocumentDataNodeService<T extends IDocumentBaseEntity, U extends CompleteIdentification<T>, PT extends IEntityIdentification, PU extends CompleteIdentification<PT>>
	 ...
	 *  Readonly processor.
	 */
	public readonlyProcessor: DocumentDataNodeReadonlyProcessorService<T, U, PT, PU> | undefined;
	/**
	 *  Date processor.
	 */
	 ...
	 */
	protected provideReadonlyProcessor(): DocumentDataNodeReadonlyProcessorService<T, U, PT, PU> | undefined {
		return new DocumentDataNodeReadonlyProcessorService(this);
	}
