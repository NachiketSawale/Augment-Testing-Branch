...
import { IBoq2estRuleEntity } from './boq-2est-rule-entity.interface';
import { IBoqBillToEntity } from './boq-bill-to-entity.interface';
import { IBoqItem2CostGroupEntity } from './boq-item-2cost-group-entity.interface';
import { IBoqItem2boqDivisiontypeEntity } from './boq-item-2boq-divisiontype-entity.interface';
import { IBoqItemEntity } from './boq-item-entity.interface';
import { IBoqItemParamEntity } from './boq-item-param-entity.interface';
import { IBoqItemSubPriceEntity } from './boq-item-sub-price-entity.interface';
...
import { IBoqWic2assemblyEntity } from './boq-wic-2assembly-entity.interface';
import { IBoqItemDocumentEntity } from './boq-item-document-entity.interface';
import { IWicBoq2mdcRuleEntity } from './wic-boq-2mdc-rule-entity.interface';
import { IDescriptionInfo, IEntityBase } from '@libs/platform/common';
import { IBoqCharacterContentEntity } from './boq-character-content-entity.interface';
import { IBoqItemFlagEntity } from './boq-item-flag-entity.interface';

export interface IBoqItemEntityGenerated extends IEntityBase {
