...
import { ProcurementRequisitionBoqDataService } from './procurement-requisition-boq.service';

@Injectable({providedIn: 'root'})
export class ProcurementRequisitionBoqItemDataService extends BoqItemDataServiceBase {
	public constructor(private readonly parentService: ProcurementRequisitionBoqDataService) {
