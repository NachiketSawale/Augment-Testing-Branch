...
/**
 * Procurement Rfq Email Fax Rfq Report Template lookup Service.
 */
export class ProcurementRfqEmailFaxRfqReportTemplatelookupService<T extends object = object> extends UiCommonLookupEndpointDataService<IReportData, T> {
    
    public constructor() {
        super({
            httpRead: {
                route: 'basics/reporting/sidebar',
                endPointRead: 'load?module=procurement.rfq',
